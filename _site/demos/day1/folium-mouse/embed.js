...
const Fe = "course/day1/folium-mouse";
async function Re() {
  return ye(Fe, /* @__PURE__ */ Object.assign({
    "/demos/course/day1/folium-mouse/image.glsl": () => Promise.resolve().then(() => Ce).then((r) => r.default)
...
const Ae = `vec2 normalize_coord(vec2 coord) {
