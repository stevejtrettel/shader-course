...
const Fe = "course/day3/square-f";
async function Re() {
  return ye(Fe, /* @__PURE__ */ Object.assign({
    "/demos/course/day3/square-f/image.glsl": () => Promise.resolve().then(() => Ce).then((r) => r.default)
...
const Ae = `vec3 drawF(vec2 p, vec3 bgColor, vec3 fgColor) {
    vec3 color = bgColor;
