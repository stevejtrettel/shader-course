  ...
  var t = function(r) {
    var s = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, o = 0, p = {}, c = {
      ...
      tokenize: function(i, a) {
        ...
        var d = new g();
        return T(d, d.head, i), v(i, d, a, d.head, 0), C(d);
      },
      /**
       * @namespace
       * @memberof Prism
...
`), F.hasAttribute("data-start") || F.setAttribute("data-start", String(h + 1));
          ...
          function(d) {
            F.setAttribute(c, v), R.textContent = d;
          }
        );
      }
...
const Fe = "course/day3/square-halfspace";
async function Ce() {
  return ye(Fe, /* @__PURE__ */ Object.assign({
    "/demos/course/day3/square-halfspace/image.glsl": () => Promise.resolve().then(() => Ae).then((r) => r.default)
