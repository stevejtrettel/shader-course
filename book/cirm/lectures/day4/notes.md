...
::shader{src="mandelbrot-waves-hook" layout="tabbed"}
...
::shader{src="texture-basic" layout="tabbed"}
...
::shader{src="texture-flip" layout="tabbed"}
...
::shader{src="texture-wavy" layout="tabbed"}
...
::shader{src="texture-swirl" layout="tabbed"}
...
::shader{src="texture-magnify" layout="tabbed"}
...
::shader{src="paint-broken" layout="tabbed"}
...
::shader{src="paint-basic" layout="tabbed"}
...
::shader{src="paint-fade" layout="tabbed"}
...
::shader{src="wave-equation" layout="tabbed"}
...
::shader{src="wave-circle" layout="tabbed"}
...
::shader{src="mandelbrot-waves" layout="tabbed"}