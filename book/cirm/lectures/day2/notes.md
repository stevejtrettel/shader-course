...
::shader{src="mandelbrot-zoom" layout="tabbed"}
...
::shader{src="mandelbrot-bw" layout="tabbed"}
...
::shader{src="mandelbrot-gray" layout="tabbed"}
...
::shader{src="mandelbrot-color" layout="tabbed"}
...
::shader{src="julia-static" layout="tabbed"}
...
::shader{src="julia-explorer" layout="tabbed"}
...
::shader{src="inversion-toggle" layout="tabbed"}
...
::shader{src="inversion-grid" layout="tabbed"}
...
::shader{src="inversion-moving" layout="tabbed"}
...
::shader{src="apollonian-setup" layout="tabbed"}
...
::shader{src="apollonian-iterated" layout="tabbed"}
...
::shader{src="apollonian-final" layout="tabbed"}
