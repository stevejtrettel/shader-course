...
::shader{src="elliptic-family" layout="tabbed"}
...
::shader{src="half-plane-pixels" layout="tabbed"}
...
::shader{src="coordinates" layout="tabbed"}
...
::shader{src="circle-ring" layout="tabbed"}
...
::shader{src="circle-pulsing" layout="tabbed"}
...
::shader{src="circle-mouse" layout="tabbed"}
...
::shader{src="sun-earth" layout="tabbed"}
...
::shader{src="parabola" layout="tabbed"}
...
::shader{src="lemniscate-naive" layout="tabbed"}
...
::shader{src="lemniscate-gradient" layout="tabbed"}
...
::shader{src="folium-mouse" layout="tabbed"}
...
::shader{src="elliptic-curve" layout="tabbed"}
