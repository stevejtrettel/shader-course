...
//  ANIMATED STREAMLINES (Common tab)
//
//  Particle-based streamline visualization.
//  V(p) is defined here and shared across all tabs.
// =============================================
...
//  PARAMETERS
//
//  VEL_FACTOR  — particle speed per frame
//  NUMBER      — number of particles
//  MIX_FACTOR  — trail persistence (0 = no trail, 1 = permanent)
//  SIZE        — particle dot radius
