...
//  LEVEL SETS — GRADIENT CORRECTED
//
//  Draws level curves of f(x,y) with consistent
//  pixel-width lines using gradient correction.
//  Color encodes sign (blue negative, red positive).
// =============================================
