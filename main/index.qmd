...
For more control and offline work, you can use the [`@stevejtrettel/shader-sandbox`](https://www.npmjs.com/package/@stevejtrettel/shader-sandbox) npm package. This provides a Shadertoy-compatible development environment that runs locally on your machine.
