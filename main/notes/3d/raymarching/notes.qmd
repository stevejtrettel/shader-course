...
The logic: `length(p.xz) - majorRadius` gives the distance from the central ring (a circle of radius $R$ in the xz-plane). Then we measure distance from that to the point, accounting for $y$, and subtract the tube radius.
