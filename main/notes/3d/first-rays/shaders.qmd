...
The 80-line quartic solver, included to show why we need a better approach.
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    if (t > 0.0) {
        ...
        vec3 normal = torusNormal(localHit, vec2(torus.majorRadius, torus.minorRadius));

        vec3 ambient = torus.color * 0.15;
        color = ambient + shade(normal, torus.color);
    }
