...
Ray makeRay(vec2 fragCoord) {
    ...
    float f = 1.0 / tan(radians(55.0) / 2.0);
...
const float SR = 0.8;
const vec3 P0 = vec3(-1.8, 0.8, 0.0);  // bare terra cotta
const vec3 P1 = vec3( 0.0, 0.8, 0.0);  // glazed terra cotta
const vec3 P2 = vec3( 1.8, 0.8, 0.0);  // glossy plastic
