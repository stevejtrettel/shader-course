...
async function Pt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Ce(t) ? kt(i, t, s) : Dt(i, t, s);
}
function Dt(i, e, t) {
  const n = At(e.layout, {
    container: i,
...
const ie = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"], Ut = ["BufferA", "BufferB", "BufferC", "BufferD"], Pe = ["iChannel0", "iChannel1", "iChannel2", "iChannel3"], Bt = "default", De = !0, Nt = "light", ke = /* @__PURE__ */ new Set([
  "iResolution",
  "iTime",
  "iTimeDelta",
  "iFrame",
...
async function Wt(i, e, t, n) {
  ...
  for (const u of ie) {
    ...
    if (!d)
      continue;
    const E = d.source ?? Mt(u), y = i.joinPath(e, E);
    if (!await i.exists(y))
...
async function Qt(i, e, t, n, s) {
  ...
  const c = await Be(r, s), l = Ne(e, n), d = await Gt(l, r, {
    config: a,
    script: c,
...
const tn = /* @__PURE__ */ Object.assign({ "./notes/3d/03-deriving-sdfs/shaders/triangle-2d/image.glsl": () => Promise.resolve().then(() => hn).then((i) => i.default) }), nn = /* @__PURE__ */ Object.assign({}), sn = /* @__PURE__ */ Object.assign({}), rn = /* @__PURE__ */ Object.assign({});
let ne = null;
async function on() {
  return ne || (ne = await Qt("notes/3d/03-deriving-sdfs/shaders/triangle-2d", tn, nn, sn, rn)), ne;
}
              ...
              if (!(N instanceof c)) {
                ...
                if (ce) {
                  if (P = l(le, D, m, B), !P || P.index >= m.length)
                    break;
                  var j = P.index, Xe = P.index + P[0].length, M = D;
                  ...
                  for (var I = L; I !== h.tail && (M < Xe || typeof I.value == "string"); I = I.next)
                    X++, M += I.value.length;
                  X--, N = m.slice(D, M), P.index -= D;
                } else if (P = l(le, 0, N, B), !P)
                  continue;
                var j = P.index, K = P[0], J = N.slice(0, j), ue = N.slice(j + K.length), Q = D + N.length;
                x && Q > x.reach && (x.reach = Q);
                var Y = L.prev;
                J && (Y = E(h, Y, J), D += J.length), y(h, Y, X);
                var je = new c(C, S ? a.tokenize(K, S) : K, He, K);
...
const Oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createEditor: un
}, Symbol.toStringTag, { value: "Module" })), dn = `float sdTriangle(vec2 p, float r) {
    p.x = abs(p.x);
