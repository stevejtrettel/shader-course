...
`), t.viewNames && t.viewNames.length > 1) {
  ...
  if (s.length > 0) {
    ...
    for (const [d, E] of s) {
      const b = E.type === "bool" ? "bool" : E.type;
      n.push(`uniform ${b} ${d};`);
    }
    n.push("");
  }
...
class ct {
  ...
  updateVideoTextures(e) {
    for (const t of this._videoTextures)
      !t.ready || !t.video || t.video.readyState < HTMLMediaElement.HAVE_CURRENT_DATA || (Qe(e, t.texture, t.video), t.video.videoWidth > 0 && (t.width = t.video.videoWidth, t.height = t.video.videoHeight));
  }
  // ===========================================================================
  // Cleanup
  // ===========================================================================
...
class ge {
  ...
  updateTexture(e, t, n, s) {
    ...
    if (r && r.width === t && r.height === n && r.isFloat === o) {
      ...
      const a = Je(this.gl, (r == null ? void 0 : r.texture) ?? null, t, n, s);
  ...
  step(e, t, n, s, r) {
    ...
    for (const E of d) {
      const b = this._passes.find((y) => y.name === E);
      b && (this.executePass(b, u), this.swapPassTextures(b));
    }
  ...
  initRuntimePasses() {
    ...
    for (const r of s) {
      ...
      try {
        const l = he(e, pe, a), u = this.cacheUniformLocations(l, o.namedSamplers), d = K(e, this._width, this._height), E = K(e, this._width, this._height), b = me(e, d), y = {
          name: r,
        ...
        if (d) {
          ...
          if (c.commonStartLine > 0 && c.commonLines > 0) {
            ...
            y >= c.commonStartLine && y <= T && (E = !0, b = y - c.commonStartLine + 1);
          }
          !E && c.userCodeStartLine > 0 && y >= c.userCodeStartLine && (b = y - c.userCodeStartLine + 1);
        }
...
class dt {
  ...
  show(e, t) {
    ...
    const n = e.filter((u) => u.isFromCommon), s = e.filter((u) => !u.isFromCommon), c = [...n.length > 0 ? [n[0]] : [], ...s].map(({ passName: u, error: d, isFromCommon: E, originalLine: b, lineMapping: y }) => {
...
`, ""), w = b;
      ...
      return {
        ...
        error: ht(_, y, E),
        codeContext: w !== null && m ? ft(m, w) : null
      };
...
class ve {
  ...
  constructor(e) {
    ...
    }), this._resizeObserver.observe(this.container), this.input = new pt(this.canvas, this._pixelRatio), this.input.onFirstGesture = () => this.initMediaOnGesture(), this.initVideoFiles();
  }
  // ===========================================================================
  // Per-Frame Rendering
  // ===========================================================================
...
class Ae {
  ...
  createVec2Pad(e, t) {
    ...
    const b = (f) => {
      const g = (f[0] - s[0]) / (r[0] - s[0]) * 100, x = (1 - (f[1] - s[1]) / (r[1] - s[1])) * 100;
      E.style.left = `${g}%`, E.style.top = `${x}%`;
    };
    b(n);
    let y = !1;
    const T = (f) => {
      const g = d.getBoundingClientRect(), x = "touches" in f ? f.touches[0].clientX : f.clientX, C = "touches" in f ? f.touches[0].clientY : f.clientY;
    ...
    return d.addEventListener("touchstart", h), document.addEventListener("touchmove", p), document.addEventListener("touchend", m), this.documentListeners.push({ type: "touchmove", handler: p }), this.documentListeners.push({ type: "touchend", handler: m }), a.appendChild(c), a.appendChild(d), {
      ...
      update: (f) => {
        const g = f;
        b(g), u.textContent = this.formatVec2(g);
      }
    };
  }
  // ===========================================================================
  ...
  createColorPicker(e, t) {
    ...
    return d.className = "uniform-control-color-swatch", d.style.backgroundColor = this.rgbToHex(n), u.addEventListener("input", () => {
      ...
      element: r,
      update: (E) => {
        const b = this.rgbToHex(E);
        u.value = b, d.style.backgroundColor = b, c.textContent = b;
      }
    };
  }
  // ===========================================================================
  ...
  createColorPicker4(e, t) {
    ...
    const E = ((T = t.step) == null ? void 0 : T[3]) ?? 0.01, { element: b, update: y } = this.createSliderRow({
      label: "Alpha",
    ...
    return r.appendChild(o), r.appendChild(l), r.appendChild(b), {
      element: r,
      update: (m) => {
        const h = m, p = this.rgbToHex(h);
        u.value = p, d.style.backgroundColor = p, c.textContent = p, y(h[3]);
      }
    };
  }
  // ===========================================================================
  ...
  createVecSliders(e, t, n) {
    ...
    return o.forEach((u, d) => {
      var _, m, h;
      const E = ((_ = t.step) == null ? void 0 : _[d]) ?? 0.01, { element: b, update: y } = this.createSliderRow({
        label: u,
        min: ((m = t.min) == null ? void 0 : m[d]) ?? 0,
        max: ((h = t.max) == null ? void 0 : h[d]) ?? 1,
        step: E,
        value: s[d],
        format: (p) => this.formatNumber(p, E),
        onInput: (p) => {
          const f = this.values[e];
          f[d] = p, this.onChange(e, [...f]);
        }
      }), T = b.querySelector(".uniform-control-label-row");
      if (T) {
        T.classList.add("uniform-control-vec-slider-row");
        const p = T.querySelector(".uniform-control-label");
        p && p.classList.add("uniform-control-vec-component");
        const f = T.querySelector(".uniform-control-value");
        f && f.classList.add("uniform-control-vec-value");
      }
      const w = b.querySelector(".uniform-control-slider");
      w && w.classList.add("uniform-control-vec-slider"), l.push(y), a.appendChild(b);
    }), {
      element: a,
      update: (u) => {
        const d = u;
...
function vt(i, e) {
  ...
  const u = !!((f = i.script) != null && f.setup || (g = i.script) != null && g.onFrame), d = Object.entries(i.uniforms).filter(([, v]) => !A(v)), E = [];
  for (const [v, R] of d) {
    if (A(R))
      continue;
    const F = s[v] ?? R.value;
  ...
  const b = d.map(([v, R]) => `uniform ${R.type === "bool" ? "bool" : R.type} ${v};`).join(`
`), y = r.map((v) => `// Array uniform: ${v.name} (max ${v.count})
...
class wt {
  constructor(e, t, n, s) {
    ...
    const b = this.createField("Format"), y = document.createElement("div");
    ...
    m.htmlFor = "render-fmt-video", m.textContent = "Video (WebM)", _.appendChild(this.formatVideo), _.appendChild(m), y.appendChild(_), y.appendChild(T), b.appendChild(y), this.estimateEl = document.createElement("div"), this.estimateEl.className = "render-estimate", this.bodyEl.appendChild(c), this.bodyEl.appendChild(d), this.bodyEl.appendChild(E), this.bodyEl.appendChild(b), this.bodyEl.appendChild(this.estimateEl), this.actionsEl = document.createElement("div"), this.actionsEl.className = "render-dialog-actions";
...
class D {
  constructor(e) {
    ...
    if (this.recorder = new Tt(this.primaryView.canvas, this.container, this.project.root), this.statsPanel = new yt(this.container), this.statsPanel.updateResolution(this.primaryView.canvas.width, this.primaryView.canvas.height), this.isMultiView) {
    ...
    if (this.project.controls && !e.skipPlaybackControls && (this.playbackControls = new bt(this.container, {
  ...
  runScriptOnFrame(e, t) {
    var s;
    if (!this.scriptAPI || !((s = this.project.script) != null && s.onFrame) || this.scriptErrorCount >= D.MAX_SCRIPT_ERRORS)
      return;
    ...
    try {
      ...
      this.scriptErrorCount++, console.error(`script.js onFrame() threw (${this.scriptErrorCount}/${D.MAX_SCRIPT_ERRORS}):`, r), this.primaryView.runtimeErrorOverlay.showError("onFrame", r), this.scriptErrorCount >= D.MAX_SCRIPT_ERRORS && (console.warn("script.js onFrame() disabled after too many errors"), this.primaryView.runtimeErrorOverlay.showDisabled());
    }
  ...
  async renderVideoFrames(e, t, n, s) {
    ...
    l.stop(), await d;
    const E = new Blob(u, { type: "video/webm" }), b = URL.createObjectURL(E), y = document.createElement("a");
    y.href = b, y.download = `render_${r.width}x${r.height}_${t}fps.webm`, y.click(), URL.revokeObjectURL(b);
  }
  stepForRender(e, t) {
    var r;
    const n = e / t, s = 1 / t;
  ...
  createPanel(e) {
    ...
    `, a.addEventListener("click", () => {
      ...
      u.className = "uniforms-container", this.controls = new Ae({
        ...
        onChange: (d, E) => {
          var b, y;
          (y = (b = this.opts).onSetUniformValue) == null || y.call(b, d, E);
        }
...
async function kt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Ce(t) ? Dt(i, t, s) : Pt(i, t, s);
}
function Pt(i, e, t) {
  const n = At(e.layout, {
    container: i,
...
const ie = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"], Ut = ["BufferA", "BufferB", "BufferC", "BufferD"], ke = ["iChannel0", "iChannel1", "iChannel2", "iChannel3"], Bt = "default", Pe = !0, Nt = "light", De = /* @__PURE__ */ new Set([
  "iResolution",
  "iTime",
  "iTimeDelta",
  "iFrame",
...
const ye = /* @__PURE__ */ new Set(["fullscreen", "default", "split", "tabbed"]), q = /* @__PURE__ */ new Set(["light", "dark", "system"]), Ot = /* @__PURE__ */ new Set([
  "mode",
  "title",
  "author",
  "description",
  ...
  "views"
  // multi-view projects
]), Ht = /* @__PURE__ */ new Set(["source", "iChannel0", "iChannel1", "iChannel2", "iChannel3"]), be = /* @__PURE__ */ new Set(["keyboard", "audio", "webcam"]);
function Vt(i, e) {
  const t = [], n = [];
  for (const r of Object.keys(i))
    Ot.has(r) || t.push(`Unknown config key '${r}'`);
  if (i.layout !== void 0 && !ye.has(i.layout) && n.push(`Invalid layout '${i.layout}'. Expected one of: ${[...ye].join(", ")}`), i.theme !== void 0 && !q.has(i.theme) && n.push(`Invalid theme '${i.theme}'. Expected one of: ${[...q].join(", ")}`), i.uniforms && typeof i.uniforms == "object")
    for (const r of Object.keys(i.uniforms))
      De.has(r) && n.push(`Uniform name '${r}' is reserved (built-in uniform)`), $(r) || n.push(`Uniform name '${r}' is not a valid GLSL identifier`);
  ...
  if (i.textures && typeof i.textures == "object")
    for (const [r, o] of Object.entries(i.textures))
      $(r) || n.push(`Texture name '${r}' is not a valid GLSL identifier`), s.has(r) && n.push(`Texture name '${r}' collides with a buffer name`), typeof o != "string" ? n.push(`Texture source for '${r}' must be a string`) : !be.has(o) && !/\.\w+$/.test(o) && !$(o) && n.push(`Invalid texture source '${o}' for '${r}'. Expected a file path with extension, a script texture name, or one of: ${[...be].join(", ")}`);
  for (const r of ie) {
    const o = i[r];
...
function Xt(i, e) {
  ...
  if (i.layout !== void 0 && !we.has(i.layout) && t.push(`Invalid multi-view layout '${i.layout}'. Expected one of: ${[...we].join(", ")}`), i.theme !== void 0 && !q.has(i.theme) && t.push(`Invalid theme '${i.theme}'. Expected one of: ${[...q].join(", ")}`), i.uniforms && typeof i.uniforms == "object")
    for (const n of Object.keys(i.uniforms))
      De.has(n) && t.push(`Uniform name '${n}' is reserved (built-in uniform)`), $(n) || t.push(`Uniform name '${n}' is not a valid GLSL identifier`);
  if (t.length > 0)
...
function W(i, e, t, n, s, r) {
  if (!i)
    return { kind: "none" };
  const o = Le(i);
  return o ? Yt(o, e, t, n, s, r) : { kind: "none" };
}
...
async function Wt(i, e, t, n) {
      ...
      if (d)
        for (const E of ke) {
          ...
          if (y && "texture" in y && !c.has(y.texture)) {
            const T = await n.textureUrlResolver(y.texture), w = y.texture.split("/").pop(), _ = a.register(T, y.filter, y.wrap, w);
            c.set(y.texture, _);
          }
        }
    }
  ...
  for (const u of ie) {
    ...
    if (!d)
      continue;
    const E = d.source ?? Mt(u), b = i.joinPath(e, E);
    if (!await i.exists(b))
      throw new Error(`Source GLSL file for pass '${u}' not found at '${E}' in '${e}'.`);
    const y = await i.readText(b), T = [
    ...
    l[u] = { name: u, glslSource: y, channels: T };
  }
  if (!l.Image)
...
async function Qt(i, e, t, n, s) {
  ...
  for (const [y, T] of a)
    l.set(y, { kind: "buffer", buffer: T, current: !1 });
  for (const [y, T] of Object.entries(t.textures ?? {}))
    if (T === "keyboard")
      l.set(y, { kind: "keyboard" });
    else if (T === "audio")
      l.set(y, { kind: "audio" });
    else if (T === "webcam")
      l.set(y, { kind: "webcam" });
      ...
      l.set(y, { kind: "texture", name: _, cubemap: !1 });
    } else Zt.has(T) || l.set(y, { kind: "script", name: T });
...
async function en(i, e, t, n, s) {
  ...
  for (const d of e.views) {
    const E = `${i}/${d}.glsl`, b = `${i}/${d}/image.glsl`;
    let y;
    if (U(t, E))
      y = await r.readText(E);
    else if (U(t, b))
      y = await r.readText(b);
    else
...
const tn = /* @__PURE__ */ Object.assign({ "./notes/3d/01-first-rays/shaders/torus-analytical/image.glsl": () => Promise.resolve().then(() => hn).then((i) => i.default) }), nn = /* @__PURE__ */ Object.assign({}), sn = /* @__PURE__ */ Object.assign({}), rn = /* @__PURE__ */ Object.assign({});
let ne = null;
async function on() {
  return ne || (ne = await Jt("notes/3d/01-first-rays/shaders/torus-analytical", tn, nn, sn, rn)), ne;
}
  ...
  var t = function(n) {
    var s = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, r = 0, o = {}, a = {
        ...
        clone: function m(h, p) {
          ...
          switch (a.util.type(h)) {
            case "Object":
              ...
              {}, p[g] = f;
              for (var x in h)
                h.hasOwnProperty(x) && (f[x] = m(h[x], p));
              return (
                /** @type {any} */
                f
              );
        ...
        insertBefore: function(m, h, p, f) {
          ...
          for (var C in g)
            if (g.hasOwnProperty(C)) {
              if (C == h)
                for (var v in p)
                  p.hasOwnProperty(v) && (x[v] = p[v]);
              p.hasOwnProperty(C) || (x[C] = g[C]);
            }
          var R = f[m];
          return f[m] = x, a.languages.DFS(a.languages, function(F, S) {
            S === R && F != m && (this[F] = x);
          }), x;
        },
        ...
        DFS: function m(h, p, f, g) {
          ...
          for (var C in h)
            if (h.hasOwnProperty(C)) {
              ...
              R === "Object" && !g[x(v)] ? (g[x(v)] = !0, m(v, p, null, g)) : R === "Array" && !g[x(v)] && (g[x(v)] = !0, m(v, p, C, g));
            }
        }
      },
      plugins: {},
      ...
      highlightAllUnder: function(m, h, p) {
        ...
        for (var g = 0, x; x = f.elements[g++]; )
          a.highlightElement(x, h === !0, f.callback);
      },
      /**
      ...
      highlightElement: function(m, h, p) {
        ...
        function R(S) {
          v.highlightedCode = S, a.hooks.run("before-insert", v), v.element.innerHTML = v.highlightedCode, a.hooks.run("after-highlight", v), a.hooks.run("complete", v), p && p.call(v.element);
        }
        if (a.hooks.run("before-sanity-check", v), x = v.element.parentElement, x && x.nodeName.toLowerCase() === "pre" && !x.hasAttribute("tabindex") && x.setAttribute("tabindex", "0"), !v.code) {
          a.hooks.run("complete", v), p && p.call(v.element);
          return;
        }
      ...
      tokenize: function(m, h) {
        ...
        var g = new d();
        return E(g, g.head, m), u(m, g, h, g.head, 0), y(g);
      },
      /**
       * @namespace
       * @memberof Prism
      ...
      for (var C in p)
        if (!(!p.hasOwnProperty(C) || !p[C])) {
          ...
          for (var R = 0; R < v.length; ++R) {
            ...
            for (var le = F.pattern || F, L = f.next, P = g; L !== h.tail && !(x && P >= x.reach); P += L.value.length, L = L.next) {
              var N = L.value;
              ...
              if (!(N instanceof c)) {
                var X = 1, k;
                if (ce) {
                  if (k = l(le, P, m, B), !k || k.index >= m.length)
                    break;
                  var j = k.index, Xe = k.index + k[0].length, M = P;
                  for (M += L.value.length; j >= M; )
                    L = L.next, M += L.value.length;
                  if (M -= L.value.length, P = M, L.value instanceof c)
                    continue;
                  for (var I = L; I !== h.tail && (M < Xe || typeof I.value == "string"); I = I.next)
                    X++, M += I.value.length;
                  X--, N = m.slice(P, M), k.index -= P;
                } else if (k = l(le, 0, N, B), !k)
                  continue;
                var j = k.index, z = k[0], Q = N.slice(0, j), ue = N.slice(j + z.length), J = P + N.length;
                x && J > x.reach && (x.reach = J);
                var Y = L.prev;
                Q && (Y = E(h, Y, Q), P += Q.length), b(h, Y, X);
                var je = new c(C, S ? a.tokenize(z, S) : z, He, z);
                if (L = E(h, Y, je), ue && E(h, L, ue), X > 1) {
                  var ee = {
                    cause: C + "," + R,
                    reach: J
                  };
                  u(m, h, p, L.prev, P, ee), x && ee.reach > x.reach && (x.reach = ee.reach);
                }
              }
            }
          }
  ...
  i.exports && (i.exports = t), typeof Re < "u" && (Re.Prism = t), t.languages.markup = {
    ...
    t.hooks.add("before-highlightall", function(T) {
      ...
      if (w.matches(d)) {
        ...
        f && f.loadLanguages(h), E(
          m,
          function(g) {
            w.setAttribute(a, l);
            var x = b(w.getAttribute("data-range"));
            if (x) {
...
`, ln.highlightElement(c);
    const b = E.split(`
`);
    s.innerHTML = b.map((y, T) => `<span>${T + 1}</span>`).join(""), t && t(E);
  }
  function u() {
  ...
  function d(E) {
    if (E.key === "Tab") {
      E.preventDefault();
      const b = o.selectionStart, y = o.selectionEnd, T = o.value;
      o.value = T.substring(0, b) + "  " + T.substring(y), o.selectionStart = o.selectionEnd = b + 2, l();
    }
  }
...
const Oe = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  createEditor: un
}, Symbol.toStringTag, { value: "Module" })), dn = `struct Ray {
    vec3 origin;
    vec3 dir;
};
...
// --- Torus Intersection (Inigo Quilez) ---
...
vec3 torusNormal(vec3 p, float R) {
    float k = sqrt(p.x*p.x + p.z*p.z);
    return normalize(vec3(p.x * (1.0 - R/k), p.y, p.z * (1.0 - R/k)));
}

float intersect(Ray ray, Torus t) {
    Ray localRay;
    localRay.origin = ray.origin - t.center;
    localRay.dir = ray.dir;
    return intersectTorusRaw(localRay, vec2(t.majorRadius, t.minorRadius));
}
...
Torus torus = Torus(vec3(0.0), 1.0, 0.4, vec3(0.0, 0.7, 1.0));

void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    Ray ray = makeRay(fragCoord);
    ray = orbitRay(ray, 4.0);

    float t = intersect(ray, torus);

    vec3 color = vec3(0.1, 0.1, 0.2);
    if (t > 0.0) {
        vec3 hitPoint = ray.origin + t * ray.dir;
        vec3 localHit = hitPoint - torus.center;
        vec3 normal = torusNormal(localHit, torus.majorRadius);
        color = shadeDiffuse(normal, torus.color);
    }
