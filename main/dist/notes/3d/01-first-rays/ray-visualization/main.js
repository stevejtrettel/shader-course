...
const tn = /* @__PURE__ */ Object.assign({ "./notes/3d/01-first-rays/shaders/ray-visualization/image.glsl": () => Promise.resolve().then(() => hn).then((i) => i.default) }), nn = /* @__PURE__ */ Object.assign({}), sn = /* @__PURE__ */ Object.assign({}), rn = /* @__PURE__ */ Object.assign({});
let ne = null;
async function on() {
  return ne || (ne = await Qt("notes/3d/01-first-rays/shaders/ray-visualization", tn, nn, sn, rn)), ne;
}
