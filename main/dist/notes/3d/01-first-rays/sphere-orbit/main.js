...
class ge {
  ...
  initRuntimePasses() {
    ...
    for (const r of s) {
      ...
      try {
        const l = he(e, pe, a), u = this.cacheUniformLocations(l, o.namedSamplers), d = z(e, this._width, this._height), E = z(e, this._width, this._height), y = me(e, d), b = {
          name: r,
  ...
  createColorPicker4(e, t) {
    ...
    return r.appendChild(o), r.appendChild(l), r.appendChild(y), {
      ...
      update: (m) => {
        ...
        u.value = p, d.style.backgroundColor = p, c.textContent = p, b(h[3]);
      }
    };
  }
  // ===========================================================================
...
async function Pt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Ce(t) ? Mt(i, t, s) : Dt(i, t, s);
}
function Dt(i, e, t) {
  const n = At(e.layout, {
    container: i,
...
const tn = /* @__PURE__ */ Object.assign({ "./notes/3d/01-first-rays/shaders/sphere-orbit/image.glsl": () => Promise.resolve().then(() => hn).then((i) => i.default) }), nn = /* @__PURE__ */ Object.assign({}), sn = /* @__PURE__ */ Object.assign({}), rn = /* @__PURE__ */ Object.assign({});
let ne = null;
async function on() {
  return ne || (ne = await Qt("notes/3d/01-first-rays/shaders/sphere-orbit", tn, nn, sn, rn)), ne;
}
async function mn(i, e = {}) {
  const t = await on();
  return Pt(i, { project: t, ...e });
}
class an {
  constructor(e, t) {
      ...
      for (var C in p)
        if (!(!p.hasOwnProperty(C) || !p[C])) {
          ...
          for (var R = 0; R < v.length; ++R) {
            ...
            for (var le = F.pattern || F, L = f.next, D = g; L !== h.tail && !(x && D >= x.reach); D += L.value.length, L = L.next) {
              var N = L.value;
              ...
              if (!(N instanceof c)) {
                ...
                if (ce) {
                  if (P = l(le, D, m, B), !P || P.index >= m.length)
                    break;
                  var j = P.index, Xe = P.index + P[0].length, k = D;
                ...
                if (L = E(h, K, je), ue && E(h, L, ue), X > 1) {
                  ...
                  u(m, h, p, L.prev, D, ee), x && ee.reach > x.reach && (x.reach = ee.reach);
                }
              }
            }
          }
