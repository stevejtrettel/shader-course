...
const tn = /* @__PURE__ */ Object.assign({ "./notes/3d/05-lighting/shaders/gamma/image.glsl": () => Promise.resolve().then(() => hn).then((i) => i.default) }), nn = /* @__PURE__ */ Object.assign({}), sn = /* @__PURE__ */ Object.assign({}), rn = /* @__PURE__ */ Object.assign({});
let ne = null;
async function on() {
  return ne || (ne = await Qt("notes/3d/05-lighting/shaders/gamma", tn, nn, sn, rn)), ne;
}
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // Split screen: left = linear (no gamma), right = gamma corrected
    ...
    // Divider line
    if (abs(uv.x - 0.5) < 0.001) color = vec3(1.0);
