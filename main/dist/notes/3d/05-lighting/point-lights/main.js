...
async function Dt(i, e) {
  ...
  return n || i.classList.add("unstyled"), oe(t.theme), Ce(t) ? kt(i, t, s) : Pt(i, t, s);
}
function Pt(i, e, t) {
  const n = At(e.layout, {
    container: i,
...
const ie = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"], Ut = ["BufferA", "BufferB", "BufferC", "BufferD"], De = ["iChannel0", "iChannel1", "iChannel2", "iChannel3"], Bt = "default", Pe = !0, It = "light", ke = /* @__PURE__ */ new Set([
  "iResolution",
  "iTime",
  "iTimeDelta",
  "iFrame",
...
const tn = /* @__PURE__ */ Object.assign({ "./notes/3d/05-lighting/shaders/point-lights/image.glsl": () => Promise.resolve().then(() => hn).then((i) => i.default) }), nn = /* @__PURE__ */ Object.assign({}), sn = /* @__PURE__ */ Object.assign({}), rn = /* @__PURE__ */ Object.assign({});
let ne = null;
async function on() {
  return ne || (ne = await Qt("notes/3d/05-lighting/shaders/point-lights", tn, nn, sn, rn)), ne;
}
              ...
              if (!(I instanceof c)) {
                ...
                if (ce) {
                  if (D = l(le, P, m, B), !D || D.index >= m.length)
                    break;
                  var j = D.index, Xe = D.index + D[0].length, M = P;
                  for (M += L.value.length; j >= M; )
                    L = L.next, M += L.value.length;
                  if (M -= L.value.length, P = M, L.value instanceof c)
                    continue;
                  for (var N = L; N !== h.tail && (M < Xe || typeof N.value == "string"); N = N.next)
                    X++, M += N.value.length;
                  X--, I = m.slice(P, M), D.index -= P;
...
// softShadow now takes maxDist: large for directional, dist for point
