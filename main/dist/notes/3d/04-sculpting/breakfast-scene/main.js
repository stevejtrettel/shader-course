...
const tn = /* @__PURE__ */ Object.assign({ "./notes/3d/04-sculpting/shaders/breakfast-scene/image.glsl": () => Promise.resolve().then(() => hn).then((i) => i.default) }), nn = /* @__PURE__ */ Object.assign({}), sn = /* @__PURE__ */ Object.assign({}), rn = /* @__PURE__ */ Object.assign({});
let ne = null;
async function on() {
  return ne || (ne = await Qt("notes/3d/04-sculpting/shaders/breakfast-scene", tn, nn, sn, rn)), ne;
}
            ...
            for (var le = F.pattern || F, L = p.next, P = g; L !== h.tail && !(x && P >= x.reach); P += L.value.length, L = L.next) {
              ...
              if (!(I instanceof c)) {
                ...
                if (ce) {
                  ...
                  continue;
                var j = D.index, z = D[0], J = I.slice(0, j), ue = I.slice(j + z.length), Q = P + I.length;
                x && Q > x.reach && (x.reach = Q);
                var Y = L.prev;
                J && (Y = E(h, Y, J), P += J.length), y(h, Y, X);
