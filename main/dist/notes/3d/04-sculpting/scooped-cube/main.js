...
const tn = /* @__PURE__ */ Object.assign({ "./notes/3d/04-sculpting/shaders/scooped-cube/image.glsl": () => Promise.resolve().then(() => hn).then((i) => i.default) }), nn = /* @__PURE__ */ Object.assign({}), sn = /* @__PURE__ */ Object.assign({}), rn = /* @__PURE__ */ Object.assign({});
let ne = null;
async function on() {
  return ne || (ne = await Qt("notes/3d/04-sculpting/shaders/scooped-cube", tn, nn, sn, rn)), ne;
}
