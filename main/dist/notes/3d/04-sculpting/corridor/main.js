...
class ge {
  ...
  resize(e, t) {
    ...
    for (const s of this._passes)
      n.deleteTexture(s.currentTexture), n.deleteTexture(s.previousTexture), n.deleteFramebuffer(s.framebuffer), s.currentTexture = Y(n, e, t), s.previousTexture = Y(n, e, t), s.framebuffer = me(n, s.currentTexture);
  }
  /**
  ...
  initRuntimePasses() {
    ...
    for (const r of s) {
      ...
      try {
        const l = he(e, fe, a), u = this.cacheUniformLocations(l, o.namedSamplers), d = Y(e, this._width, this._height), E = Y(e, this._width, this._height), y = me(e, d), b = {
          name: r,
...
async function Qt(i, e, t, n, s) {
  ...
  const c = await Be(r, s), l = Ie(e, n), d = await Yt(l, r, {
    config: a,
    script: c,
...
const tn = /* @__PURE__ */ Object.assign({ "./notes/3d/04-sculpting/shaders/corridor/image.glsl": () => Promise.resolve().then(() => hn).then((i) => i.default) }), nn = /* @__PURE__ */ Object.assign({}), sn = /* @__PURE__ */ Object.assign({}), rn = /* @__PURE__ */ Object.assign({});
let ne = null;
async function on() {
  return ne || (ne = await Qt("notes/3d/04-sculpting/shaders/corridor", tn, nn, sn, rn)), ne;
}
            ...
            for (var le = F.pattern || F, L = p.next, D = g; L !== h.tail && !(x && D >= x.reach); D += L.value.length, L = L.next) {
              ...
              if (!(I instanceof c)) {
                ...
                if (ce) {
                  ...
                  continue;
                var j = P.index, z = P[0], J = I.slice(0, j), ue = I.slice(j + z.length), Q = D + I.length;
