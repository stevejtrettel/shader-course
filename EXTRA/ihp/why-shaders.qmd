...
This is a workshop about using shaders — small programs that run on your GPU — to make pictures of mathematics.
It's aimed at working mathematicians, especially geometers and topologists, who want to visualize things from their research but haven't encountered GPU programming before.
...
Instead, we'll focus on a single, specific tool — the *fragment shader* — and build up a conceptual framework for understanding what it's good at and why.
