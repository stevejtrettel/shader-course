...
const ke = "course/day4/paint-fade";
async function Me() {
  return Be(ke, /* @__PURE__ */ Object.assign({
    "/demos/course/day4/paint-fade/bufferA.glsl": () => Promise.resolve().then(() => $e).then((r) => r.default),
    "/demos/course/day4/paint-fade/image.glsl": () => Promise.resolve().then(() => Oe).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/course/day4/paint-fade/config.json": () => Promise.resolve().then(() => ze).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({}));
}
async function Ge(n) {
