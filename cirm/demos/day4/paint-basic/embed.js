...
var me = (n, e, t) => e in n ? fe(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
...
function J(n, e) {
  ...
  if (r !== n.FRAMEBUFFER_COMPLETE)
    throw n.deleteFramebuffer(t), new Error(`Framebuffer incomplete: ${ye(n, r)}`);
...
class xe {
   ...
   */
  initRuntimePasses() {
    const e = this.gl, t = this.project, r = ge(e), i = ["BufferA", "BufferB", "BufferC", "BufferD", "Image"];
    for (const l of i) {
      const s = t.passes[l];
      if (!s) continue;
...
class _e {
  ...
  showErrorOverlay(e) {
    ...
    const t = e.filter((g) => g.isFromCommon), r = e.filter((g) => !g.isFromCommon), a = [...t.length > 0 ? [t[0]] : [], ...r].map(({ passName: g, error: v, source: C, isFromCommon: x, originalLine: w }) => {
...
function ne(n) {
  return typeof n == "string" ? Re(n) ? { buffer: n } : n === "keyboard" ? { keyboard: !0 } : { texture: n } : n;
}
async function Be(n, e, t, r) {
  const i = `/demos/${n}/config.json`;
  if (i in t) {
    const s = await t[i]();
    return s.Image || s.BufferA || s.BufferB || s.BufferC || s.BufferD ? Le(n, s, e, r) : ee(n, e, s);
  } else
    return ee(n, e);
}
async function ee(n, e, t) {
  ...
  const l = await e[i](), s = (t == null ? void 0 : t.layout) || "tabbed", a = (t == null ? void 0 : t.controls) ?? !0, f = (t == null ? void 0 : t.title) || n.split("-").map((g) => g.charAt(0).toUpperCase() + g.slice(1)).join(" ");
  return {
    root: `/demos/${n}`,
    meta: {
      title: f,
...
async function Le(n, e, t, r) {
  ...
  const C = e.title || n.split("-").map((E) => E.charAt(0).toUpperCase() + E.slice(1)).join(" "), x = e.author || null, w = e.description || null, A = e.layout || "tabbed", y = e.controls ?? !0;
  return {
    root: `/demos/${n}`,
...
const ke = "course/day4/paint-basic";
async function Me() {
  return Be(ke, /* @__PURE__ */ Object.assign({
    "/demos/course/day4/paint-basic/bufferA.glsl": () => Promise.resolve().then(() => $e).then((r) => r.default),
    "/demos/course/day4/paint-basic/image.glsl": () => Promise.resolve().then(() => Oe).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/course/day4/paint-basic/config.json": () => Promise.resolve().then(() => ze).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({}));
}
async function Ge(n) {
  ...
  const t = await Me(), r = Se(t.layout, {
    container: e,
    project: t
  }), i = new _e({
...
function Ue(n, e, t) {
  ...
  f.className = "language-cpp", a.appendChild(f), l.appendChild(s), l.appendChild(a), r.appendChild(i), r.appendChild(l), n.appendChild(r);
  function g() {
    const x = s.value;
    f.textContent = x + `
...
`);
  ...
  return s.addEventListener("input", g), s.addEventListener("scroll", v), s.addEventListener("keydown", C), g(), {
    ...
    destroy: () => {
      s.removeEventListener("input", g), s.removeEventListener("scroll", v), s.removeEventListener("keydown", C), n.removeChild(r);
    }
  };
}
...
`, $e = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Ne
}, Symbol.toStringTag, { value: "Module" })), je = `void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
