        ...
        insertBefore: function(i, a, u, l) {
          ...
          for (var v in d)
            if (d.hasOwnProperty(v)) {
              ...
              u.hasOwnProperty(v) || (h[v] = d[v]);
            }
          var F = l[i];
          return l[i] = h, o.languages.DFS(o.languages, function(A, M) {
            M === F && A != i && (this[A] = h);
          }), h;
        },
        ...
        DFS: function i(a, u, l, d) {
          ...
          for (var v in a)
            if (a.hasOwnProperty(v)) {
              ...
              F === "Object" && !d[h(f)] ? (d[h(f)] = !0, i(f, u, null, d)) : F === "Array" && !d[h(f)] && (d[h(f)] = !0, i(f, u, v, d));
            }
        }
      },
      plugins: {},
      ...
      for (var v in u)
        if (!(!u.hasOwnProperty(v) || !u[v])) {
          ...
          for (var F = 0; F < f.length; ++F) {
            ...
            for (var q = A.pattern || A, S = l.next, B = d; S !== a.tail && !(h && B >= h.reach); B += S.value.length, S = S.next) {
              var P = S.value;
              ...
              if (!(P instanceof m)) {
                ...
                if (S = x(a, O, ie), W && x(a, S, W), I > 1) {
                  ...
                  T(i, a, u, S.prev, B, G), h && G.reach > h.reach && (h.reach = G.reach);
                }
              }
            }
          }
    ...
    t.hooks.add("before-highlightall", function(_) {
      ...
      if (w.matches(E)) {
        ...
        l && l.loadLanguages(a), x(
          ...
          function(d) {
            w.setAttribute(o, b);
            var h = y(w.getAttribute("data-range"));
            if (h) {
              var v = d.split(/\r\n?|\n/g), f = h[0], F = h[1] == null ? v.length : h[1];
...
async function we(n, e, t, r) {
  ...
  for (const h of c) {
    const v = `/demos/${n}/${h.replace(/^\.\//, "")}`;
    if (!(v in r))
      throw new Error(`Texture not found: ${h} (expected at ${v})`);
    const f = await r[v](), F = h.split("/").pop().replace(/\.[^.]+$/, "");
    o.push({
      name: F,
      source: f,
      filter: "linear",
  ...
  const T = ((u = e.meta) == null ? void 0 : u.title) || n.split("-").map((h) => h.charAt(0).toUpperCase() + h.slice(1)).join(" "), E = ((l = e.meta) == null ? void 0 : l.author) || null, x = ((d = e.meta) == null ? void 0 : d.description) || null, y = e.layout || "tabbed", C = e.controls ?? !0;
  return {
    root: `/demos/${n}`,
