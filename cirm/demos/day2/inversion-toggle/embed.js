...
const Fe = "course/day2/inversion-toggle";
async function Re() {
  return ye(Fe, /* @__PURE__ */ Object.assign({
    "/demos/course/day2/inversion-toggle/image.glsl": () => Promise.resolve().then(() => Ce).then((r) => r.default)
...
const Ae = `vec2 normalize_coord(vec2 fragCoord) {
