...
{{< shader layout="tabbed" hook-animated-tiling >}}
...
{{< shader layout="tabbed" strip-circle >}}
...
{{< shader layout="tabbed" square-foldcount >}}
...
{{< shader layout="tabbed" square-parity >}}
...
{{< shader layout="tabbed" halfspace-single >}}
...
{{< shader layout="tabbed" square-halfspace >}}
...
{{< shader layout="tabbed" triangle-tiling >}}
...
{{< shader layout="tabbed" hyp-halfspaces >}}
...
{{< shader layout="tabbed" hyp-reflect-f >}}
...
{{< shader layout="tabbed" hyp-triangle-halfspaces >}}
...
{{< shader layout="tabbed" hyp-tiling-23inf >}}
...
{{< shader layout="tabbed" poincare-disk >}}
...
{{< shader layout="tabbed" hyp-tiling-237 >}}
