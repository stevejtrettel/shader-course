...
{{< shader layout="tabbed" mandelbrot-waves-hook >}}
...
{{< shader layout="tabbed" texture-basic >}}
...
{{< shader layout="tabbed" texture-flip >}}
...
{{< shader layout="tabbed" texture-wavy >}}
...
{{< shader layout="tabbed" texture-swirl >}}
...
{{< shader layout="tabbed" texture-magnify >}}
...
{{< shader layout="tabbed" paint-broken >}}
...
{{< shader layout="tabbed" paint-basic >}}
...
{{< shader layout="tabbed" paint-fade >}}
...
{{< shader layout="tabbed" wave-equation >}}
...
{{< shader layout="tabbed" wave-circle >}}
...
{{< shader layout="tabbed" mandelbrot-waves >}}