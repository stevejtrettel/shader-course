...
{{< shader layout="tabbed" elliptic-family >}}
...
{{< shader layout="tabbed" half-plane-pixels >}}
...
{{< shader layout="tabbed" coordinates >}}
...
{{< shader layout="tabbed" circle-ring >}}
...
{{< shader layout="tabbed" circle-pulsing >}}
...
{{< shader layout="tabbed" circle-mouse >}}
...
{{< shader layout="tabbed" sun-earth >}}
...
{{< shader layout="tabbed" lemniscate-naive >}}
...
{{< shader layout="tabbed" lemniscate-gradient >}}
...
{{< shader layout="tabbed" folium-mouse >}}
...
{{< shader layout="tabbed" elliptic-curve >}}
