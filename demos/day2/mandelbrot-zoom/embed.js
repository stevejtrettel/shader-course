...
class Ee {
   ...
   */
  initRuntimePasses() {
    const e = this.gl, t = this.project, r = le(e), i = ["BufferA", "BufferB", "BufferC", "BufferD", "Image"];
    for (const c of i) {
      const p = t.passes[c];
      if (!p) continue;
...
var Y = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, ee = { exports: {} };
(function(n) {
  ...
  var t = function(r) {
    var i = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, c = 0, p = {}, o = {
      ...
      tokenize: function(s, a) {
        ...
        var h = new E();
        return x(h, h.head, s), T(s, h, a, h.head, 0), R(h);
      },
      /**
       * @namespace
       * @memberof Prism
          ...
          for (var F = 0; F < f.length; ++F) {
            ...
            for (var q = C.pattern || C, S = l.next, B = h; S !== a.tail && !(d && B >= d.reach); B += S.value.length, S = S.next) {
              ...
              if (!(P instanceof m)) {
                ...
                var z = S.prev;
                H && (z = x(a, z, H), B += H.length), y(a, z, $);
                var ie = new m(v, M ? o.tokenize(O, M) : O, re, O);
                if (S = x(a, z, ie), W && x(a, S, W), $ > 1) {
                  var G = {
                    cause: v + "," + F,
                    reach: X
                  };
  ...
  n.exports && (n.exports = t), typeof Y < "u" && (Y.Prism = t), t.languages.markup = {
    comment: {
      pattern: /<!--(?:(?!<!--)[\s\S])*?-->/,
      greedy: !0
    },
...
const Re = "course/day2/mandelbrot-zoom";
async function Ae() {
  return we(Re, /* @__PURE__ */ Object.assign({
    "/demos/course/day2/mandelbrot-zoom/image.glsl": () => Promise.resolve().then(() => Se).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/course/day2/mandelbrot-zoom/config.json": () => Promise.resolve().then(() => Me).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({}));
}
async function ke(n) {
