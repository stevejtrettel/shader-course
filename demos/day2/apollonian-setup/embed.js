      ...
      for (var v in u)
        if (!(!u.hasOwnProperty(v) || !u[v])) {
          ...
          for (var F = 0; F < f.length; ++F) {
            ...
            for (var q = A.pattern || A, S = l.next, B = h; S !== a.tail && !(p && B >= p.reach); B += S.value.length, S = S.next) {
              var P = S.value;
              ...
              if (!(P instanceof m)) {
                ...
                var ie = new m(v, M ? o.tokenize(O, M) : O, ne, O);
...
async function we(n, e, t, r) {
  ...
  const T = ((u = e.meta) == null ? void 0 : u.title) || n.split("-").map((p) => p.charAt(0).toUpperCase() + p.slice(1)).join(" "), E = ((l = e.meta) == null ? void 0 : l.author) || null, x = ((h = e.meta) == null ? void 0 : h.description) || null, y = e.layout || "tabbed", C = e.controls ?? !0;
  return {
    root: `/demos/${n}`,
...
const Fe = "course/day2/apollonian-setup";
async function Ce() {
  return ye(Fe, /* @__PURE__ */ Object.assign({
    "/demos/course/day2/apollonian-setup/image.glsl": () => Promise.resolve().then(() => Ae).then((r) => r.default)
