...
class me {
  ...
  resize(e, t) {
    ...
    for (const s of this._passes)
      r.deleteTexture(s.currentTexture), r.deleteTexture(s.previousTexture), r.deleteFramebuffer(s.framebuffer), s.currentTexture = z(r, e, t), s.previousTexture = z(r, e, t), s.framebuffer = Z(r, s.currentTexture);
  }
  /**
  ...
  initRuntimePasses() {
    ...
    for (const o of s) {
      ...
      try {
        ...
        }, v = z(e, this._width, this._height), g = z(e, this._width, this._height), T = Z(e, v), y = {
          name: o,
          ...
          for (var w = 0; w < h.length; ++w) {
            ...
            for (var W = C.pattern || C, L = l.next, B = d; L !== a.tail && !(m && B >= m.reach); B += L.value.length, L = L.next) {
              ...
              if (!(U instanceof E)) {
                ...
                var j = L.prev;
                G && (j = T(a, j, G), B += G.length), y(a, j, I);
...
const Fe = "course/day3/square-parity";
async function Re() {
  return ye(Fe, /* @__PURE__ */ Object.assign({
    "/demos/course/day3/square-parity/image.glsl": () => Promise.resolve().then(() => Ce).then((r) => r.default)
