  ...
  initRuntimePasses() {
    ...
    for (const o of s) {
      ...
      try {
        ...
        }, v = z(e, this._width, this._height), g = z(e, this._width, this._height), T = Z(e, v), _ = {
          name: o,
...
const Fe = "course/day1/elliptic-family";
async function Re() {
  return _e(Fe, /* @__PURE__ */ Object.assign({
    "/demos/course/day1/elliptic-family/image.glsl": () => Promise.resolve().then(() => Ce).then((r) => r.default)
