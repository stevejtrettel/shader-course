...
const Ae = "course/day4/mandelbrot-waves";
async function Re() {
  return Fe(Ae, /* @__PURE__ */ Object.assign({
    "/demos/course/day4/mandelbrot-waves/bufferA.glsl": () => Promise.resolve().then(() => Le).then((r) => r.default),
    "/demos/course/day4/mandelbrot-waves/common.glsl": () => Promise.resolve().then(() => Be).then((r) => r.default),
    "/demos/course/day4/mandelbrot-waves/image.glsl": () => Promise.resolve().then(() => Pe).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/course/day4/mandelbrot-waves/config.json": () => Promise.resolve().then(() => De).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({}));
}
async function Ie(n) {
