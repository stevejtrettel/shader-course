...
var ue = (n, e, t) => e in n ? ce(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var g = (n, e, t) => ue(n, typeof e != "symbol" ? e + "" : e, t);
function K(n, e, t) {
...
function Y(n, e) {
  ...
  if (r !== n.FRAMEBUFFER_COMPLETE)
    throw n.deleteFramebuffer(t), new Error(`Framebuffer incomplete: ${me(n, r)}`);
...
class be {
   ...
   */
  initRuntimePasses() {
    const e = this.gl, t = this.project, r = he(e), s = ["BufferA", "BufferB", "BufferC", "BufferD", "Image"];
    for (const c of s) {
      const p = t.passes[c];
      if (!p) continue;
   ...
   */
  getLineMapping() {
    const e = Ee + 1, t = this.project.commonSource ? this.project.commonSource.split(`
`).length : 0;
...
class ve {
  constructor(e) {
    ...
    this.gl = t, this.updateCanvasSize(), this.engine = new be({
      gl: this.gl,
      project: e.project
    ...
    var s = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, c = 0, p = {}, o = {
      ...
      languages: {
        ...
        insertBefore: function(i, a, u, l) {
          ...
          var F = l[i];
          return l[i] = d, o.languages.DFS(o.languages, function(R, M) {
            M === F && R != i && (this[R] = d);
          }), d;
        },
      ...
      tokenize: function(i, a) {
        ...
        var h = new E();
        return x(h, h.head, i), T(i, h, a, h.head, 0), C(h);
      },
      /**
       * @namespace
       * @memberof Prism
      ...
      for (var v in u)
        if (!(!u.hasOwnProperty(v) || !u[v])) {
          ...
          for (var F = 0; F < f.length; ++F) {
            if (d && d.cause == v + "," + F)
              return;
            var R = f[F], M = R.inside, D = !!R.lookbehind, V = !!R.greedy, ae = R.alias;
            if (V && !R.pattern.global) {
              var ie = R.pattern.toString().match(/[imsuy]*$/)[0];
              R.pattern = RegExp(R.pattern.source, ie + "g");
            }
            for (var q = R.pattern || R, S = l.next, B = h; S !== a.tail && !(d && B >= d.reach); B += S.value.length, S = S.next) {
              var P = S.value;
              ...
              if (!(P instanceof m)) {
                ...
                if (V) {
                  if (L = b(q, B, i, D), !L || L.index >= i.length)
                    break;
                  var I = L.index, se = L.index + L[0].length, k = B;
                  for (k += S.value.length; I >= k; )
                    S = S.next, k += S.value.length;
                  if (k -= S.value.length, B = k, S.value instanceof m)
                    continue;
                  for (var U = S; U !== a.tail && (k < se || typeof U.value == "string"); U = U.next)
                    $++, k += U.value.length;
                ...
                var oe = new m(v, M ? o.tokenize(O, M) : O, ae, O);
                if (S = x(a, N, oe), W && x(a, S, W), $ > 1) {
                  var G = {
                    cause: v + "," + F,
                    reach: X
                  };
  ...
  n.exports && (n.exports = t), typeof Z < "u" && (Z.Prism = t), t.languages.markup = {
    ...
    function x(_, w, A) {
      ...
      i.open("GET", _, !0), i.onreadystatechange = function() {
        i.readyState == 4 && (i.status < 400 && i.responseText ? w(i.responseText) : i.status >= 400 ? A(s(i.status, i.statusText)) : A(c));
      }, i.send(null);
    }
    function y(_) {
      var w = /^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(_ || "");
      if (w) {
        var A = Number(w[1]), i = w[2], a = w[3];
...
`), w.hasAttribute("data-start") || w.setAttribute("data-start", String(f + 1));
            ...
            A.textContent = h, t.highlightElement(A);
          },
          function(h) {
            w.setAttribute(o, T), A.textContent = h;
          }
        );
      }
      ...
      highlight: function(w) {
        for (var A = (w || document).querySelectorAll(E), i = 0, a; a = A[i++]; )
...
async function Fe(n, e, t, r) {
  ...
  if (p) {
    const o = await t[p]();
    return o.passes ? Ce(n, o, e, r) : Q(n, e, o);
  } else
    return Q(n, e);
}
...
async function Ce(n, e, t, r) {
  ...
  for (const d of p) {
    ...
    }, F = v.source || f[d], R = `/demos/${n}/${F}`;
    if (!(R in t))
      throw new Error(`Missing shader file: ${R}`);
    const M = await t[R](), D = [
...
const Ae = "course/day4/wave-circle";
async function Re() {
  return Fe(Ae, /* @__PURE__ */ Object.assign({
    "/demos/course/day4/wave-circle/bufferA.glsl": () => Promise.resolve().then(() => Le).then((r) => r.default),
    "/demos/course/day4/wave-circle/image.glsl": () => Promise.resolve().then(() => Be).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/course/day4/wave-circle/config.json": () => Promise.resolve().then(() => Pe).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({}));
}
async function De(n) {
  ...
  const t = await Re(), r = we(t.layout, {
    container: e,
    project: t
  }), s = new ve({
...
const Se = `bool inDomain(vec2 fragCoord) {
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
  ...
  __proto__: null,
  default: Se
}, Symbol.toStringTag, { value: "Module" })), Me = `bool inDomain(vec2 fragCoord, vec2 resolution) {
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
  ...
  __proto__: null,
  default: Me
}, Symbol.toStringTag, { value: "Module" })), ne = !0, re = {
  BufferA: {
    channels: {
      iChannel0: {
        buffer: "BufferA",
