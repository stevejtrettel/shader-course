...
const Ce = "course/day4/paint-fade";
async function Re() {
  return Fe(Ce, /* @__PURE__ */ Object.assign({
    "/demos/course/day4/paint-fade/bufferA.glsl": () => Promise.resolve().then(() => Le).then((r) => r.default),
    "/demos/course/day4/paint-fade/image.glsl": () => Promise.resolve().then(() => Be).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/course/day4/paint-fade/config.json": () => Promise.resolve().then(() => Pe).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({}));
}
async function De(n) {
