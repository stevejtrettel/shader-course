...
const ke = "course/day4/wave-interactive";
async function Me() {
  return Be(ke, /* @__PURE__ */ Object.assign({
    "/demos/course/day4/wave-interactive/bufferA.glsl": () => Promise.resolve().then(() => $e).then((n) => n.default),
    "/demos/course/day4/wave-interactive/image.glsl": () => Promise.resolve().then(() => Oe).then((n) => n.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/course/day4/wave-interactive/config.json": () => Promise.resolve().then(() => ze).then((n) => n.default)
  }), /* @__PURE__ */ Object.assign({}));
}
async function Ge(r) {
