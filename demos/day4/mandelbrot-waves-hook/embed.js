...
const ke = "course/day4/mandelbrot-waves-hook";
async function Me() {
  return Be(ke, /* @__PURE__ */ Object.assign({
    "/demos/course/day4/mandelbrot-waves-hook/bufferA.glsl": () => Promise.resolve().then(() => $e).then((n) => n.default),
    "/demos/course/day4/mandelbrot-waves-hook/common.glsl": () => Promise.resolve().then(() => Oe).then((n) => n.default),
    "/demos/course/day4/mandelbrot-waves-hook/image.glsl": () => Promise.resolve().then(() => ze).then((n) => n.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/course/day4/mandelbrot-waves-hook/config.json": () => Promise.resolve().then(() => Ge).then((n) => n.default)
  }), /* @__PURE__ */ Object.assign({}));
}
async function Ke(r) {
