...
var le = (n, e, t) => e in n ? ue(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var g = (n, e, t) => le(n, typeof e != "symbol" ? e + "" : e, t);
function K(n, e, t) {
...
function Y(n, e) {
  ...
  if (r !== n.FRAMEBUFFER_COMPLETE)
    throw n.deleteFramebuffer(t), new Error(`Framebuffer incomplete: ${ge(n, r)}`);
...
class ve {
  constructor(e) {
    ...
    this.gl = e.gl, this.project = e.project, this._width = this.gl.drawingBufferWidth, this._height = this.gl.drawingBufferHeight, this.initExtensions(), this._blackTexture = pe(this.gl);
    const t = fe(this.gl);
   ...
   */
  initRuntimePasses() {
    const e = this.gl, t = this.project, r = de(e), i = ["BufferA", "BufferB", "BufferC", "BufferD", "Image"];
    for (const c of i) {
      const p = t.passes[c];
      if (!p) continue;
   ...
   */
  getLineMapping() {
    const e = be + 1, t = this.project.commonSource ? this.project.commonSource.split(`
`).length : 0;
      ...
      for (var v in u)
        if (!(!u.hasOwnProperty(v) || !u[v])) {
          ...
          for (var F = 0; F < f.length; ++F) {
            if (d && d.cause == v + "," + F)
              return;
            var R = f[F], M = R.inside, D = !!R.lookbehind, V = !!R.greedy, se = R.alias;
              ...
              if (!(P instanceof m)) {
                ...
                if (V) {
                  if (L = b(q, B, s, D), !L || L.index >= s.length)
                    break;
                  var I = L.index, oe = L.index + L[0].length, k = B;
                  for (k += S.value.length; I >= k; )
                    S = S.next, k += S.value.length;
                  if (k -= S.value.length, B = k, S.value instanceof m)
                    continue;
                  for (var U = S; U !== a.tail && (k < oe || typeof U.value == "string"); U = U.next)
                    $++, k += U.value.length;
                ...
                var ce = new m(v, M ? o.tokenize(O, M) : O, se, O);
                if (S = x(a, N, ce), W && x(a, S, W), $ > 1) {
                  var G = {
                    cause: v + "," + F,
                    reach: X
                  };
...
const Re = "course/day4/wave-equation";
async function Se() {
  return Ae(Re, /* @__PURE__ */ Object.assign({
    "/demos/course/day4/wave-equation/bufferA.glsl": () => Promise.resolve().then(() => Me).then((r) => r.default),
    "/demos/course/day4/wave-equation/image.glsl": () => Promise.resolve().then(() => ke).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/course/day4/wave-equation/config.json": () => Promise.resolve().then(() => Ue).then((r) => r.default)
  }), /* @__PURE__ */ Object.assign({}));
}
async function $e(n) {
  ...
  const t = await Se(), r = Fe(t.layout, {
    container: e,
    project: t
  }), i = new Te({
...
const Le = `void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    if (iFrame == 0) {
  ...
  __proto__: null,
  default: Le
}, Symbol.toStringTag, { value: "Module" })), Be = `void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
  ...
  title: "Simple Paint",
  description: "Click and drag to draw. Press R to clear."
}, re = !0, ae = {
  BufferA: {
    channels: {
      iChannel0: {
