...
{{< shader-demo day5/hook-demo >}}

[TODO: Overview and hook description - to be written last]
...
Why `> 0.5` instead of `== 1.0`? Floating-point comparisons can be tricky, and thresholding at 0.5 is more robust. Similarly, `> 1.5 && < 3.5` checks for 2 or 3 neighbors without exact equality tests.
...
{{< shader-demo day5/heat-equation >}}
...
{{< shader-demo day5/heat-interactive >}}
...
{{< shader-demo day5/wave-equation >}}
...
{{< shader-demo day5/wave-interactive >}}
...
{{< shader-demo day5/wave-triangle >}}
