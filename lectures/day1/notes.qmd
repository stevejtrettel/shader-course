...
So far our shaders have been static. Let's make something move.
...
### Coming Full Circle: Elliptic Curves

Remember the opening demo? We can now build it ourselves. An elliptic curve in Weierstrass form is $y^2 = x^3 + ax + b$. As an implicit curve: $F(x,y) = y^2 - x^3 - ax - b = 0$.
