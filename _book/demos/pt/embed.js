...
function Y(n, e, t) {
  ...
  if (n.shaderSource(a, t), n.compileShader(a), !n.getShaderParameter(a, n.COMPILE_STATUS)) {
    ...
    throw n.deleteShader(a), new Error(`Shader compilation failed:
${i}`);
  }
  return a;
}
function ue(n, e, t) {
  const a = Y(n, n.VERTEX_SHADER, e), s = Y(n, n.FRAGMENT_SHADER, t), i = n.createProgram();
  if (!i)
    throw new Error("Failed to create program object");
  if (n.attachShader(i, a), n.attachShader(i, s), n.linkProgram(i), !n.getProgramParameter(i, n.LINK_STATUS)) {
    const c = n.getProgramInfoLog(i);
    throw n.deleteProgram(i), n.deleteShader(a), n.deleteShader(s), new Error(`Program linking failed:
${c}`);
  }
  return n.detachShader(i, a), n.detachShader(i, s), n.deleteShader(a), n.deleteShader(s), i;
}
function Ae(n) {
  ...
  return n.bindBuffer(n.ARRAY_BUFFER, a), n.bufferData(n.ARRAY_BUFFER, t, n.STATIC_DRAW), n.enableVertexAttribArray(0), n.vertexAttribPointer(
    0,
    // attribute location
    2,
    // size (vec2)
...
function K(n, e, t) {
  ...
  return n.bindTexture(n.TEXTURE_2D, a), n.texImage2D(
    n.TEXTURE_2D,
    0,
    // mip level
    n.RGBA32F,
  ...
  ), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MIN_FILTER, n.NEAREST), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_MAG_FILTER, n.NEAREST), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_S, n.CLAMP_TO_EDGE), n.texParameteri(n.TEXTURE_2D, n.TEXTURE_WRAP_T, n.CLAMP_TO_EDGE), n.bindTexture(n.TEXTURE_2D, null), a;
}
function Q(n, e) {
  ...
  const a = n.checkFramebufferStatus(n.FRAMEBUFFER);
  if (a !== n.FRAMEBUFFER_COMPLETE)
    throw n.deleteFramebuffer(t), new Error(`Framebuffer incomplete: ${fe(n, a)}`);
...
function pe(n) {
  ...
  n.bindTexture(n.TEXTURE_2D, e);
  const t = 256, a = 3, s = new Float32Array(t * a * 4);
  return n.texImage2D(
    n.TEXTURE_2D,
    0,
    n.RGBA32F,
...
function de(n, e, t, a) {
  ...
  for (let c = 0; c < 256; c++) {
    const I = t.get(c) || !1, C = a.get(c) || 0, T = (0 * 256 + c) * 4;
    p[T + 0] = I ? 1 : 0, p[T + 1] = I ? 1 : 0, p[T + 2] = I ? 1 : 0, p[T + 3] = 1;
    const h = (2 * 256 + c) * 4;
    p[h + 0] = C, p[h + 1] = C, p[h + 2] = C, p[h + 3] = 1;
  }
...
class Ce {
   ...
   */
  step(e, t) {
    const a = this.gl, s = this._lastStepTime === null ? 0 : e - this._lastStepTime;
    this._lastStepTime = e, this._time = e;
    const i = [this._width, this._height, 1], p = this._time, c = s, I = this._frame, C = t;
    a.viewport(0, 0, this._width, this._height);
    const T = ["BufferA", "BufferB", "BufferC", "BufferD", "Image"];
    for (const h of T) {
      const S = this._passes.find((j) => j.name === h);
  ...
  resize(e, t) {
    ...
    for (const s of this._passes)
      a.deleteTexture(s.currentTexture), a.deleteTexture(s.previousTexture), a.deleteFramebuffer(s.framebuffer), s.currentTexture = K(a, e, t), s.previousTexture = K(a, e, t), s.framebuffer = Q(a, s.currentTexture);
  }
  /**
   ...
   */
  updateKeyState(e, t) {
    const a = this._keyStates.get(e) || !1;
    if (this._keyStates.set(e, t), t && !a) {
  ...
  initProjectTextures() {
    ...
    for (const t of this.project.textures) {
      ...
      if (!a)
        throw new Error("Failed to create texture");
      e.bindTexture(e.TEXTURE_2D, a), e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, 1, 1, 0, e.RGBA, e.UNSIGNED_BYTE, new Uint8Array([0, 0, 0, 255]));
      const s = {
        name: t.name,
        texture: a,
        width: 1,
      ...
      i.crossOrigin = "anonymous", i.onload = () => {
        e.bindTexture(e.TEXTURE_2D, a), e.texImage2D(e.TEXTURE_2D, 0, e.RGBA, e.RGBA, e.UNSIGNED_BYTE, i);
   ...
   */
  initRuntimePasses() {
    const e = this.gl, t = this.project, a = Ae(e), s = ["BufferA", "BufferB", "BufferC", "BufferD", "Image"];
    for (const i of s) {
      const p = t.passes[i];
      if (!p) continue;
      ...
      try {
        const I = ue(e, he, c), C = {
          program: I,
          iResolution: e.getUniformLocation(I, "iResolution"),
          iTime: e.getUniformLocation(I, "iTime"),
          iTimeDelta: e.getUniformLocation(I, "iTimeDelta"),
          iFrame: e.getUniformLocation(I, "iFrame"),
          iMouse: e.getUniformLocation(I, "iMouse"),
          iChannel: [
            e.getUniformLocation(I, "iChannel0"),
            e.getUniformLocation(I, "iChannel1"),
            e.getUniformLocation(I, "iChannel2"),
            e.getUniformLocation(I, "iChannel3")
          ]
        }, T = K(e, this._width, this._height), h = K(e, this._width, this._height), S = Q(e, T), j = {
          name: i,
        ...
        const C = I instanceof Error ? I.message : String(I), T = this.getLineMapping(), h = C.match(/ERROR:\s*\d+:(\d+):/);
        let S = !1, j = null;
        if (h && this.project.commonSource) {
          const k = parseInt(h[1], 10), P = T.boilerplateLinesBeforeCommon + 2, q = P + T.commonLineCount - 1;
          k >= P && k <= q && (S = !0, j = k - P + 1);
        }
        this._compilationErrors.push({
          ...
          isFromCommon: S,
          originalLine: j
        }), console.error(`Failed to compile ${i}:`, C);
      }
    }
  }
  /**
   ...
   */
  getLineMapping() {
    const e = Ie + 1, t = this.project.commonSource ? this.project.commonSource.split(`
`).length : 0;
...
`);
    const a = this.preprocessCubemapTextures(e);
    return t.push("// User shader code"), t.push(a), t.push(""), t.push(`// Main wrapper
out vec4 fragColor;
...
`);
  ...
  preprocessCubemapTextures(e) {
    ...
    return e.replace(t, (a, s, i) => i.includes("fragCoord") || // Using fragCoord directly
    i.includes("/") || // Division (likely uv calculation)
    /\.xy\s*$/.test(i.trim()) || // Ends with .xy swizzle
    /\.st\s*$/.test(i.trim()) || // Ends with .st swizzle
    /^vec2\s*\(/.test(i.trim()) ? a : `texture(${s}, _st_dirToEquirect(${i}))`);
  }
  // ===========================================================================
  // Pass Execution
  // ===========================================================================
  executePass(e, t) {
    const a = this.gl;
    a.bindFramebuffer(a.FRAMEBUFFER, e.framebuffer), a.useProgram(e.uniforms.program), a.bindVertexArray(e.vao), this.bindBuiltinUniforms(e.uniforms, t), this.bindChannelTextures(e), a.drawArrays(a.TRIANGLES, 0, 3), a.bindVertexArray(null), a.useProgram(null), a.bindFramebuffer(a.FRAMEBUFFER, null);
  }
  bindBuiltinUniforms(e, t) {
    const a = this.gl;
    e.iResolution && a.uniform3f(e.iResolution, t.iResolution[0], t.iResolution[1], t.iResolution[2]), e.iTime && a.uniform1f(e.iTime, t.iTime), e.iTimeDelta && a.uniform1f(e.iTimeDelta, t.iTimeDelta), e.iFrame && a.uniform1i(e.iFrame, t.iFrame), e.iMouse && a.uniform4f(e.iMouse, t.iMouse[0], t.iMouse[1], t.iMouse[2], t.iMouse[3]);
  }
  bindChannelTextures(e) {
    const t = this.gl;
    for (let a = 0; a < 4; a++) {
      const s = e.projectChannels[a], i = this.resolveChannelTexture(s, e.name);
      t.activeTexture(t.TEXTURE0 + a), t.bindTexture(t.TEXTURE_2D, i);
      const p = e.uniforms.iChannel[a];
      p && t.uniform1i(p, a);
    }
  }
  /**
  ...
  resolveChannelTexture(e, t) {
    switch (e.kind) {
      ...
      default:
        const a = e;
        throw new Error(`Unknown channel source: ${JSON.stringify(a)}`);
    }
  }
  /**
   ...
   */
  swapPassTextures(e) {
    const t = this.gl, a = e.currentTexture;
    e.currentTexture = e.previousTexture, e.previousTexture = a, t.bindFramebuffer(t.FRAMEBUFFER, e.framebuffer), t.framebufferTexture2D(
      t.FRAMEBUFFER,
      t.COLOR_ATTACHMENT0,
      t.TEXTURE_2D,
      e.currentTexture,
...
class Te {
  constructor(e) {
    ...
    f(this, "animate", (e) => {
      if (this.animationId = requestAnimationFrame(this.animate), this.isPaused)
        return;
      const t = e / 1e3, a = t - this.startTime;
      this.updateFps(t), this.engine.updateKeyboardTexture(), this.engine.step(a, this.mouse), this.presentToScreen();
    });
    ...
    this.gl = t, this.updateCanvasSize(), this.engine = new Ce({
      gl: this.gl,
      project: e.project
  ...
  // ===========================================================================
  updateCanvasSize() {
    const e = this.container.getBoundingClientRect(), t = Math.floor(e.width * this.pixelRatio), a = Math.floor(e.height * this.pixelRatio);
    (this.canvas.width !== t || this.canvas.height !== a) && (this.canvas.width = t, this.canvas.height = a);
  }
  // ===========================================================================
  // Mouse Tracking
  // ===========================================================================
  setupMouseTracking() {
    const e = (a) => {
      const s = this.canvas.getBoundingClientRect(), i = (a.clientX - s.left) * this.pixelRatio, p = (s.height - (a.clientY - s.top)) * this.pixelRatio;
   ...
   */
  screenshot() {
    const e = this.project.root.split("/").pop() || "shader", t = /* @__PURE__ */ new Date(), a = t.getFullYear().toString() + (t.getMonth() + 1).toString().padStart(2, "0") + t.getDate().toString().padStart(2, "0") + "-" + t.getHours().toString().padStart(2, "0") + t.getMinutes().toString().padStart(2, "0") + t.getSeconds().toString().padStart(2, "0"), s = `shadertoy-${e}-${a}.png`;
  ...
  showErrorOverlay(e) {
    ...
    const t = e.filter((C) => C.isFromCommon), a = e.filter((C) => !C.isFromCommon), c = [...t.length > 0 ? [t[0]] : [], ...a].map(({ passName: C, error: T, source: h, isFromCommon: S, originalLine: j }) => {
      const k = T.replace(`Shader compilation failed:
`, "");
      let P = k;
      return S && j !== null && (P = k.replace(/Line \d+:/, `Line ${j}:`), P = P.replace(/ERROR:\s*\d+:(\d+):/, `ERROR: 0:${j}:`)), {
        passName: S ? "common.glsl" : C,
        error: this.parseShaderError(P),
        codeContext: S ? this.extractCodeContextFromCommon(j) : this.extractCodeContext(P, h)
      };
    }).map(({ passName: C, error: T, codeContext: h }) => `
      <div class="error-section">
        <div class="error-pass-name">${C}</div>
    ...
    `;
    const I = this.errorOverlay.querySelector(".error-close");
    I && I.addEventListener("click", () => this.hideErrorOverlay());
  }
  /**
...
`);
  ...
  extractCodeContext(e, t) {
    const a = e.match(/ERROR:\s*\d+:(\d+):/);
    if (!a) return null;
    const s = parseInt(a[1], 10), i = t.split(`
`), p = 3, c = Math.max(0, s - p - 1), I = Math.min(i.length, s + p);
    return i.slice(c, I).map((h, S) => {
      const j = c + S + 1, k = j === s, P = String(j).padStart(4, " "), q = this.escapeHTML(h);
      return k ? `<span class="error-line-highlight">${P} │ ${q}</span>` : `<span class="context-line">${P} │ ${q}</span>`;
    }).join("");
  }
  /**
  ...
  extractCodeContextFromCommon(e) {
    ...
    if (!t) return null;
    const a = t.split(`
`), s = 3, i = Math.max(0, e - s - 1), p = Math.min(a.length, e + s);
    return a.slice(i, p).map((C, T) => {
      const h = i + T + 1, S = h === e, j = String(h).padStart(4, " "), k = this.escapeHTML(C);
...
var _ = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, ee = { exports: {} };
(function(n) {
  ...
  var t = function(a) {
    var s = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, i = 0, p = {}, c = {
      ...
      util: {
        encode: function o(r) {
          return r instanceof I ? new I(r.type, o(r.content), r.alias) : Array.isArray(r) ? r.map(o) : r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ");
        },
        /**
         ...
         * @template T
         */
        clone: function o(r, l) {
          l = l || {};
          var u, A;
          switch (c.util.type(r)) {
            case "Object":
              if (A = c.util.objId(r), l[A])
                return l[A];
              u = /** @type {Record<string, any>} */
              {}, l[A] = u;
              for (var d in r)
                r.hasOwnProperty(d) && (u[d] = o(r[d], l));
              return (
                /** @type {any} */
                u
              );
            case "Array":
              return A = c.util.objId(r), l[A] ? l[A] : (u = [], l[A] = u, /** @type {Array} */
              /** @type {any} */
        ...
        setLanguage: function(o, r) {
          o.className = o.className.replace(RegExp(s, "gi"), ""), o.classList.add("language-" + r);
        },
        /**
        ...
        insertBefore: function(o, r, l, u) {
          ...
          for (var x in A)
            if (A.hasOwnProperty(x)) {
              ...
              l.hasOwnProperty(x) || (d[x] = A[x]);
            }
          var y = u[o];
          return u[o] = d, c.languages.DFS(c.languages, function(R, H) {
            H === y && R != o && (this[R] = d);
          }), d;
        },
        // Traverse a language definition with Depth First Search
        DFS: function o(r, l, u, A) {
          A = A || {};
          var d = c.util.objId;
          for (var x in r)
            if (r.hasOwnProperty(x)) {
              l.call(r, x, r[x], u || x);
              var g = r[x], y = c.util.type(g);
              y === "Object" && !A[d(g)] ? (A[d(g)] = !0, o(g, l, null, A)) : y === "Array" && !A[d(g)] && (A[d(g)] = !0, o(g, l, x, A));
            }
        }
      },
      plugins: {},
      ...
      highlightAll: function(o, r) {
        c.highlightAllUnder(document, o, r);
      },
      /**
       ...
       * @public
       */
      highlightAllUnder: function(o, r, l) {
        var u = {
          callback: l,
          container: o,
        ...
        for (var A = 0, d; d = u.elements[A++]; )
          c.highlightElement(d, r === !0, u.callback);
      },
      /**
       ...
       * @public
       */
      highlightElement: function(o, r, l) {
        var u = c.util.getLanguage(o), A = c.languages[u];
        c.util.setLanguage(o, u);
        var d = o.parentElement;
        d && d.nodeName.toLowerCase() === "pre" && c.util.setLanguage(d, u);
        var x = o.textContent, g = {
          element: o,
          language: u,
          grammar: A,
          code: x
        ...
        if (r && a.Worker) {
          ...
          y(c.highlight(g.code, g.grammar, g.language));
      },
      /**
      ...
      highlight: function(o, r, l) {
        ...
        return u.tokens = c.tokenize(u.code, u.grammar), c.hooks.run("after-tokenize", u), I.stringify(c.util.encode(u.tokens), u.language);
      },
      /**
      ...
      tokenize: function(o, r) {
        ...
        var A = new h();
        return S(A, A.head, o), T(o, A, r, A.head, 0), k(A);
      },
      /**
       * @namespace
       * @memberof Prism
    ...
    a.Prism = c;
    function I(o, r, l, u) {
      this.type = o, this.content = r, this.alias = l, this.length = (u || "").length | 0;
    }
    I.stringify = function o(r, l) {
      if (typeof r == "string")
        return r;
      if (Array.isArray(r)) {
        var u = "";
      ...
      for (var g in A.attributes)
        x += " " + g + '="' + (A.attributes[g] || "").replace(/"/g, "&quot;") + '"';
      return "<" + A.tag + ' class="' + A.classes.join(" ") + '"' + x + ">" + A.content + "</" + A.tag + ">";
    };
    function C(o, r, l, u) {
      o.lastIndex = r;
      var A = o.exec(l);
    ...
    function T(o, r, l, u, A, d) {
      for (var x in l)
        if (!(!l.hasOwnProperty(x) || !l[x])) {
          var g = l[x];
          g = Array.isArray(g) ? g : [g];
          for (var y = 0; y < g.length; ++y) {
            if (d && d.cause == x + "," + y)
              return;
            var R = g[y], H = R.inside, w = !!R.lookbehind, W = !!R.greedy, N = R.alias;
            if (W && !R.pattern.global) {
              var oe = R.pattern.toString().match(/[imsuy]*$/)[0];
              R.pattern = RegExp(R.pattern.source, oe + "g");
            }
            for (var z = R.pattern || R, V = u.next, U = A; V !== r.tail && !(d && U >= d.reach); U += V.value.length, V = V.next) {
              var v = V.value;
              ...
              if (!(v instanceof I)) {
                var F = 1, O;
                if (W) {
                  if (O = C(z, U, o, w), !O || O.index >= o.length)
                    break;
                  var E = O.index, se = O.index + O[0].length, b = U;
                  for (b += V.value.length; E >= b; )
                    V = V.next, b += V.value.length;
                  if (b -= V.value.length, U = b, V.value instanceof I)
                    continue;
                  for (var J = V; J !== r.tail && (b < se || typeof J.value == "string"); J = J.next)
                    F++, b += J.value.length;
                  F--, v = o.slice(U, b), O.index -= U;
                } else if (O = C(z, 0, v, w), !O)
                  continue;
                var E = O.index, G = O[0], M = v.slice(0, E), X = v.slice(E + G.length), B = U + v.length;
                d && B > d.reach && (d.reach = B);
                var D = V.prev;
                M && (D = S(r, D, M), U += M.length), j(r, D, F);
                var ie = new I(x, H ? c.tokenize(G, H) : G, N, G);
                if (V = S(r, D, ie), X && S(r, V, X), F > 1) {
                  var Z = {
                    cause: x + "," + y,
                    reach: B
                  };
                  T(o, r, l, V.prev, U, Z), d && Z.reach > d.reach && (d.reach = Z.reach);
                }
              }
            }
          }
    ...
    function S(o, r, l) {
      var u = r.next, A = { value: l, prev: r, next: u };
      return r.next = A, u.prev = A, o.length++, A;
    }
    function j(o, r, l) {
      for (var u = r.next, A = 0; A < l && u !== o.tail; A++)
        u = u.next;
      r.next = u, u.prev = r, o.length -= A;
    }
    function k(o) {
      for (var r = [], l = o.head.next; l !== o.tail; )
        r.push(l.value), l = l.next;
      return r;
    }
    if (!a.document)
      return a.addEventListener && (c.disableWorkerMessageHandler || a.addEventListener("message", function(o) {
        var r = JSON.parse(o.data), l = r.language, u = r.code, A = r.immediateClose;
        a.postMessage(c.highlight(u, c.languages[l], l)), A && a.close();
      }, !1)), c;
    var P = c.util.currentScript();
    P && (c.filename = P.src, P.hasAttribute("data-manual") && (c.manual = !0));
    function q() {
      c.manual || c.highlightAll();
    }
    if (!c.manual) {
      var m = document.readyState;
      m === "loading" || m === "interactive" && P && P.defer ? document.addEventListener("DOMContentLoaded", q) : window.requestAnimationFrame ? window.requestAnimationFrame(q) : window.setTimeout(q, 16);
    }
    return c;
  }(e);
  n.exports && (n.exports = t), typeof _ < "u" && (_.Prism = t), t.languages.markup = {
    ...
    var a = "Loading…", s = function(P, q) {
      return "✖ Error " + P + " while fetching file: " + q;
      ...
      h: "c",
      tex: "latex"
    }, c = "data-src-status", I = "loading", C = "loaded", T = "failed", h = "pre[data-src]:not([" + c + '="' + C + '"]):not([' + c + '="' + I + '"])';
    function S(P, q, m) {
      var o = new XMLHttpRequest();
      o.open("GET", P, !0), o.onreadystatechange = function() {
        o.readyState == 4 && (o.status < 400 && o.responseText ? q(o.responseText) : o.status >= 400 ? m(s(o.status, o.statusText)) : m(i));
      }, o.send(null);
    }
    function j(P) {
      var q = /^\s*(\d+)\s*(?:(,)\s*(?:(\d+)\s*)?)?$/.exec(P || "");
      if (q) {
        var m = Number(q[1]), o = q[2], r = q[3];
        return o ? r ? [m, Number(r)] : [m, void 0] : [m, m];
      }
    }
    t.hooks.add("before-highlightall", function(P) {
      ...
      if (q.matches(h)) {
        P.code = "", q.setAttribute(c, I);
        var m = q.appendChild(document.createElement("CODE"));
        m.textContent = a;
        var o = q.getAttribute("data-src"), r = P.language;
        if (r === "none") {
          var l = (/\.(\w+)$/.exec(o) || [, "none"])[1];
          r = p[l] || l;
        }
        t.util.setLanguage(m, r), t.util.setLanguage(q, r);
        var u = t.plugins.autoloader;
        u && u.loadLanguages(r), S(
          o,
          function(A) {
            q.setAttribute(c, C);
            var d = j(q.getAttribute("data-range"));
            if (d) {
              var x = A.split(/\r\n?|\n/g), g = d[0], y = d[1] == null ? x.length : d[1];
              g < 0 && (g += x.length), g = Math.max(0, Math.min(g - 1, x.length)), y < 0 && (y += x.length), y = Math.max(0, Math.min(y, x.length)), A = x.slice(g, y).join(`
`), q.hasAttribute("data-start") || q.setAttribute("data-start", String(g + 1));
            }
            m.textContent = A, t.highlightElement(m);
          },
          function(A) {
            q.setAttribute(c, T), m.textContent = A;
          }
        );
      }
      ...
      highlight: function(q) {
        for (var m = (q || document).querySelectorAll(h), o = 0, r; r = m[o++]; )
...
class je {
  ...
  buildCodePanel() {
    ...
    const a = this.project.passes.Image;
    e.push({ name: "image.glsl", source: a.glslSource });
    ...
    `, T = (h) => {
      ...
      k.className = "language-cpp", k.textContent = S.source, j.appendChild(k), i.innerHTML = "", i.appendChild(j), te.highlightElement(k);
    };
    p.addEventListener("click", async () => {
      try {
        await navigator.clipboard.writeText(c), p.innerHTML = C, p.classList.add("copied"), setTimeout(() => {
          p.innerHTML = I, p.classList.remove("copied");
        }, 1500);
      } catch (h) {
      ...
      j.className = "tab-button", j.textContent = h.name, S === 0 && j.classList.add("active"), j.addEventListener("click", () => {
        s.querySelectorAll(".tab-button").forEach((k) => k.classList.remove("active")), j.classList.add("active"), T(S);
      }), s.appendChild(j);
    }), this.codePanel.appendChild(s), this.codePanel.appendChild(p), this.codePanel.appendChild(i), e.length > 0 && T(0);
  }
}
class xe {
  constructor(e) {
    ...
    const a = this.buildTabBar();
    t.appendChild(a), t.appendChild(this.contentArea), this.root.appendChild(t), this.container.appendChild(this.root);
  }
  getCanvasContainer() {
    return this.canvasContainer;
  }
  ...
  buildTabBar() {
    ...
    for (const C of a) {
      const T = this.project.passes[C];
      T && t.push({
        name: `${C.toLowerCase()}.glsl`,
        isShader: !1,
        source: T.glslSource
      });
    }
    ...
    this.copyButton.addEventListener("click", async () => {
      try {
        await navigator.clipboard.writeText(i), this.copyButton.innerHTML = c, this.copyButton.classList.add("copied"), setTimeout(() => {
    ...
    const I = (C) => {
      const T = t[C];
      if (e.querySelectorAll(".tabbed-tab-button").forEach((h, S) => {
        h.classList.toggle("active", S === C);
      }), T.isShader)
        ...
        this.canvasContainer.style.visibility = "hidden", this.codeViewer.style.visibility = "visible", this.copyButton.style.visibility = "visible", i = T.source || "";
        const h = i.split(`
`), S = document.createElement("pre"), j = document.createElement("div");
        j.className = "tabbed-line-numbers", j.innerHTML = h.map((q, m) => m + 1).join(`
`);
        const k = document.createElement("div");
        k.className = "tabbed-code-content";
        const P = document.createElement("code");
        P.className = "language-cpp", P.textContent = i, k.appendChild(P), S.appendChild(j), S.appendChild(k), this.codeViewer.innerHTML = "", this.codeViewer.appendChild(S), te.highlightElement(P);
      }
    };
    return t.forEach((C, T) => {
      const h = document.createElement("button");
      h.className = "tabbed-tab-button", C.isShader && h.classList.add("shader-tab"), h.textContent = C.name, T === 0 && h.classList.add("active"), h.addEventListener("click", () => I(T)), e.appendChild(h);
    }), e;
  }
}
function ye(n, e) {
...
async function qe(n, e, t, a) {
  return `/demos/${n}/shadertoy.config.json` in t ? me(n, t, e, a) : ke(n, e);
}
...
async function me(n, e, t, a) {
  ...
  const c = /* @__PURE__ */ new Set(), I = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"];
  for (const g of I) {
    const y = i.passes[g];
    if (y)
      for (const R of ["iChannel0", "iChannel1", "iChannel2", "iChannel3"]) {
        const H = (m = y.channels) == null ? void 0 : m[R];
        H && "texture" in H && c.add(H.texture);
      }
  }
  const C = [], T = /* @__PURE__ */ new Map();
  for (const g of c) {
    const y = `/demos/${n}/${g.replace(/^\.\//, "")}`;
    if (!(y in a))
      throw new Error(`Texture not found: ${g} (expected at ${y})`);
    const R = await a[y](), H = g.split("/").pop().replace(/\.[^.]+$/, "");
    C.push({
      name: H,
      source: R,
      filter: "linear",
  ...
  for (const g of I) {
    ...
    }, H = y.source || R[g], w = `/demos/${n}/${H}`;
    if (!(w in t))
      throw new Error(`Missing shader file: ${w}`);
    const W = await t[w](), N = [
      L((o = y.channels) == null ? void 0 : o.iChannel0, T),
      L((r = y.channels) == null ? void 0 : r.iChannel1, T),
      L((l = y.channels) == null ? void 0 : l.iChannel2, T),
      L((u = y.channels) == null ? void 0 : u.iChannel3, T)
    ];
    h[g] = {
      name: g,
      glslSource: W,
  ...
  const S = ((A = i.meta) == null ? void 0 : A.title) || n.split("-").map((g) => g.charAt(0).toUpperCase() + g.slice(1)).join(" "), j = ((d = i.meta) == null ? void 0 : d.author) || null, k = ((x = i.meta) == null ? void 0 : x.description) || null, P = i.layout || "centered", q = i.controls ?? !1;
  return {
    root: `/demos/${n}`,
...
async function He() {
  return qe(Re, /* @__PURE__ */ Object.assign({
    "/demos/demofox-pt1/bufferA.glsl": () => Promise.resolve().then(() => Oe).then((a) => a.default),
    "/demos/demofox-pt1/image.glsl": () => Promise.resolve().then(() => be).then((a) => a.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/demofox-pt1/shadertoy.config.json": () => Promise.resolve().then(() => ve).then((a) => a.default)
  }), /* @__PURE__ */ Object.assign({
    "/demos/demofox-pt1/textures/equirect.jpg": () => Promise.resolve().then(() => We).then((a) => a.default)
  }));
}
async function Ee(n) {
  ...
  const t = await He(), a = ye(t.layout, {
    container: e,
    project: t
  }), s = new Te({
    container: a.getCanvasContainer(),
    project: t,
...
const Ve = `// The minimunm distance a ray must travel before we consider an intersection.
