...
function he(n, e, t, r) {
  const h = new Float32Array(3072);
  for (let o = 0; o < 256; o++) {
    const m = t.get(o) || !1, b = r.get(o) || 0, T = (0 * 256 + o) * 4;
    h[T + 0] = m ? 1 : 0, h[T + 1] = m ? 1 : 0, h[T + 2] = m ? 1 : 0, h[T + 3] = 1;
    const E = (2 * 256 + o) * 4;
    h[E + 0] = b, h[E + 1] = b, h[E + 2] = b, h[E + 3] = 1;
  }
...
class ge {
  ...
  step(e, t) {
    ...
    const c = [this._width, this._height, 1], h = this._time, o = s, m = this._frame, b = t;
  ...
  initProjectTextures() {
    ...
    for (const t of this.project.textures) {
      ...
      c.crossOrigin = "anonymous", c.onload = () => {
        ...
        const h = t.filter === "nearest" ? e.NEAREST : e.LINEAR;
        e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MIN_FILTER, h), e.texParameteri(e.TEXTURE_2D, e.TEXTURE_MAG_FILTER, h);
  ...
  initRuntimePasses() {
    ...
    for (const c of s) {
      const h = t.passes[c];
      if (!h) continue;
      const o = this.buildFragmentShader(h.glslSource);
      try {
        const m = ce(e, fe, o), b = {
          program: m,
...
`);
  ...
  resolveChannelTexture(e, t) {
    switch (e.kind) {
      ...
      case "buffer": {
        const s = this._passes.find((h) => h.name === e.buffer);
        if (!s)
...
class Ee {
  ...
  setupMouseTracking() {
    const e = (r) => {
      const s = this.canvas.getBoundingClientRect(), c = (r.clientX - s.left) * this.pixelRatio, h = (s.height - (r.clientY - s.top)) * this.pixelRatio;
      this.mouse[0] = c, this.mouse[1] = h;
    }, t = (r) => {
      const s = this.canvas.getBoundingClientRect(), c = (r.clientX - s.left) * this.pixelRatio, h = (s.height - (r.clientY - s.top)) * this.pixelRatio;
      this.mouse[2] = c, this.mouse[3] = h;
    };
  ...
  screenshot() {
    ...
    this.canvas.toBlob((c) => {
      ...
      const h = URL.createObjectURL(c), o = document.createElement("a");
      o.href = h, o.download = s, o.click(), URL.revokeObjectURL(h), console.log(`Screenshot saved: ${s}`);
    }, "image/png");
  }
  /**
...
`), h = 3, o = Math.max(0, s - h - 1), m = Math.min(c.length, s + h);
    return c.slice(o, m).map((E, x) => {
      const y = o + x + 1, C = y === s, _ = String(y).padStart(4, " "), w = this.escapeHTML(E);
  ...
  extractCodeContextFromCommon(e) {
    ...
    if (!t) return null;
    const r = t.split(`
`), s = 3, c = Math.max(0, e - s - 1), h = Math.min(r.length, e + s);
    return r.slice(c, h).map((b, T) => {
...
(function(n) {
   ...
   */
  var t = function(r) {
    var s = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, c = 0, h = {}, o = {
      /**
        ...
        insertBefore: function(i, a, u, l) {
          ...
          for (var v in d)
            if (d.hasOwnProperty(v)) {
              ...
              u.hasOwnProperty(v) || (p[v] = d[v]);
            }
          var F = l[i];
          return l[i] = p, o.languages.DFS(o.languages, function(A, M) {
            M === F && A != i && (this[A] = p);
          }), p;
        },
        ...
        DFS: function i(a, u, l, d) {
          ...
          for (var v in a)
            if (a.hasOwnProperty(v)) {
              ...
              F === "Object" && !d[p(f)] ? (d[p(f)] = !0, i(f, u, null, d)) : F === "Array" && !d[p(f)] && (d[p(f)] = !0, i(f, u, v, d));
            }
        }
      },
      plugins: {},
    ...
    m.stringify = function i(a, u) {
      ...
      p && (Array.isArray(p) ? Array.prototype.push.apply(d.classes, p) : d.classes.push(p)), o.hooks.run("wrap", d);
      var v = "";
      ...
      for (var v in u)
        if (!(!u.hasOwnProperty(v) || !u[v])) {
          ...
          for (var F = 0; F < f.length; ++F) {
            ...
            for (var q = A.pattern || A, S = l.next, B = d; S !== a.tail && !(p && B >= p.reach); B += S.value.length, S = S.next) {
              var P = S.value;
              ...
              if (!(P instanceof m)) {
                ...
                if (V) {
                  ...
                  for (var U = S; U !== a.tail && (k < ae || typeof U.value == "string"); U = U.next)
                    I++, k += U.value.length;
                  I--, P = i.slice(B, k), L.index -= B;
                } else if (L = b(q, 0, P, D), !L)
                  continue;
                var $ = L.index, N = L[0], H = P.slice(0, $), W = P.slice($ + N.length), X = B + P.length;
                p && X > p.reach && (p.reach = X);
                var O = S.prev;
                H && (O = x(a, O, H), B += H.length), y(a, O, I);
                var ie = new m(v, M ? o.tokenize(N, M) : N, ne, N);
                if (S = x(a, O, ie), W && x(a, S, W), I > 1) {
                  var G = {
                    cause: v + "," + F,
                    reach: X
                  };
  ...
  n.exports && (n.exports = t), typeof Z < "u" && (Z.Prism = t), t.languages.markup = {
    ...
    var r = "Loading…", s = function(_, w) {
      return "✖ Error " + _ + " while fetching file: " + w;
    }, c = "✖ Error: File does not exist or is empty", h = {
      js: "javascript",
      py: "python",
      rb: "ruby",
      ps1: "powershell",
    ...
    t.hooks.add("before-highlightall", function(_) {
      ...
      if (w.matches(E)) {
        ...
        R.textContent = r;
        var i = w.getAttribute("data-src"), a = _.language;
        if (a === "none") {
        ...
        l && l.loadLanguages(a), x(
          ...
          function(d) {
            ...
            if (p) {
              ...
              f < 0 && (f += v.length), f = Math.max(0, Math.min(f - 1, v.length)), F < 0 && (F += v.length), F = Math.max(0, Math.min(F, v.length)), d = v.slice(f, F).join(`
...
class Te {
  ...
  buildCodePanel() {
    ...
    h.className = "copy-button", h.innerHTML = `
    ...
    `, h.title = "Copy code to clipboard";
    let o = "";
    const m = h.innerHTML, b = `
      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
    ...
    h.addEventListener("click", async () => {
      try {
        await navigator.clipboard.writeText(o), h.innerHTML = b, h.classList.add("copied"), setTimeout(() => {
          h.innerHTML = m, h.classList.remove("copied");
        }, 1500);
      } catch (E) {
      ...
      y.className = "tab-button", y.textContent = E.name, x === 0 && y.classList.add("active"), y.addEventListener("click", () => {
        s.querySelectorAll(".tab-button").forEach((C) => C.classList.remove("active")), y.classList.add("active"), T(x);
      }), s.appendChild(y);
    }), this.codePanel.appendChild(s), this.codePanel.appendChild(h), this.codePanel.appendChild(c), e.length > 0 && T(0);
  }
}
class xe {
  constructor(e) {
  ...
  buildTabBar() {
    ...
    let c = "";
    const h = this.copyButton.innerHTML, o = `
      <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
        <path d="M13.78 4.22a.75.75 0 010 1.06l-7.25 7.25a.75.75 0 01-1.06 0L2.22 9.28a.75.75 0 011.06-1.06L6 10.94l6.72-6.72a.75.75 0 011.06 0z"/>
      </svg>
    `;
    this.copyButton.addEventListener("click", async () => {
      try {
        await navigator.clipboard.writeText(c), this.copyButton.innerHTML = o, this.copyButton.classList.add("copied"), setTimeout(() => {
          this.copyButton.innerHTML = h, this.copyButton.classList.remove("copied");
        }, 1500);
      } catch (b) {
...
async function ye(n, e, t, r) {
  ...
  if (s in t) {
    const h = await t[s]();
    return h.passes ? we(n, h, e, r) : Q(n, e, h);
  } else
    return Q(n, e);
}
async function Q(n, e, t) {
  ...
  const s = await e[r](), c = (t == null ? void 0 : t.layout) || "tabbed", h = (t == null ? void 0 : t.controls) ?? !0, o = ((m = t == null ? void 0 : t.meta) == null ? void 0 : m.title) || n.split("-").map((E) => E.charAt(0).toUpperCase() + E.slice(1)).join(" ");
  return {
    root: `/demos/${n}`,
    meta: {
      title: o,
...
async function we(n, e, t, r) {
  ...
  const c = /* @__PURE__ */ new Set(), h = ["Image", "BufferA", "BufferB", "BufferC", "BufferD"];
  for (const p of h) {
    const v = e.passes[p];
    if (v)
  ...
  const T = ((u = e.meta) == null ? void 0 : u.title) || n.split("-").map((p) => p.charAt(0).toUpperCase() + p.slice(1)).join(" "), E = ((l = e.meta) == null ? void 0 : l.author) || null, x = ((d = e.meta) == null ? void 0 : d.description) || null, y = e.layout || "tabbed", C = e.controls ?? !0;
  return {
    root: `/demos/${n}`,
...
const Fe = "course/day2/apollonian-iterated";
async function Ce() {
  return ye(Fe, /* @__PURE__ */ Object.assign({
    "/demos/course/day2/apollonian-iterated/image.glsl": () => Promise.resolve().then(() => Ae).then((r) => r.default)
